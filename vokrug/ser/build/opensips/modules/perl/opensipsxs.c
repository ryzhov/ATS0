...
#line 978 "opensipsxs.xs"
#line 1006 "opensipsxs.c"
#line 979 "opensipsxs.xs"
...
#line 1018 "opensipsxs.xs"
#line 1040 "opensipsxs.c"
#line 1019 "opensipsxs.xs"
#line 1042 "opensipsxs.c"
#line 1020 "opensipsxs.xs"
	switch (level) {
	case L_ALERT:	LM_ALERT("%s", log); break;
	case L_CRIT:	LM_CRIT("%s", log); break;
	case L_ERR:	LM_ERR("%s", log); break;
...
#line 1048 "opensipsxs.xs"
    struct sip_msg *msg = sv2msg(self);
#line 1074 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1050 "opensipsxs.xs"
#line 1078 "opensipsxs.c"
#line 1051 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
#line 1080 "opensipsxs.xs"
	struct sip_msg *msg = sv2msg(self);
#line 1114 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1082 "opensipsxs.xs"
#line 1118 "opensipsxs.c"
#line 1083 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
XS(XS_OpenSIPS__Message_resetFlag)
{
	...
	SV *	self = ST(0);
	unsigned int	flag = (unsigned int)SvUV(ST(1));
#line 1104 "opensipsxs.xs"
	struct sip_msg *msg = sv2msg(self);
#line 1148 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1106 "opensipsxs.xs"
#line 1152 "opensipsxs.c"
#line 1107 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
XS(XS_OpenSIPS__Message_isFlagSet)
{
	...
	SV *	self = ST(0);
	unsigned int	flag = (unsigned int)SvUV(ST(1));
#line 1127 "opensipsxs.xs"
	struct sip_msg *msg = sv2msg(self);
#line 1182 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1129 "opensipsxs.xs"
#line 1186 "opensipsxs.c"
#line 1130 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
#line 1154 "opensipsxs.xs"
	struct sip_msg *msg = sv2msg(self);
	char *ret;
#line 1217 "opensipsxs.c"
	SV *	RETVAL;
#line 1157 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		ST(0) = &PL_sv_undef;
	} else {
...
#line 1190 "opensipsxs.xs"
#line 1274 "opensipsxs.c"
#line 1191 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
#line 1251 "opensipsxs.xs"
	struct sip_msg *msg = sv2msg(self);
#line 1343 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1253 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
XS(XS_OpenSIPS__Message_next_branches)
{
    ...
    {
	SV *	self = ST(0);
#line 1274 "opensipsxs.xs"
	struct sip_msg *msg = sv2msg(self);
#line 1374 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1276 "opensipsxs.xs"
  	if (!msg) {
		LM_ERR("Invalid message reference\n");
		RETVAL = -1;
	} else {
...
XS(XS_OpenSIPS__Message_getParsedRURI)
{
    ...
    {
	SV *	self = ST(0);
#line 1298 "opensipsxs.xs"
    struct sip_msg *msg = sv2msg(self);
    struct sip_uri *uri;
    SV *ret;
#line 1407 "opensipsxs.c"
	SV *	RETVAL;
#line 1302 "opensipsxs.xs"
#line 1410 "opensipsxs.c"
#line 1303 "opensipsxs.xs"
	if (!msg) {
		LM_ERR("Invalid message reference\n");
		ST(0) = NULL;
	} else {
...
#line 1669 "opensipsxs.xs"
	...
	char *s;
	STRLEN len;
#line 1915 "opensipsxs.c"
	int	RETVAL;
	dXSTARG;
#line 1678 "opensipsxs.xs"
	if (SvOK(p_name)) {
		if (!sv2int_str(p_name, &name, &flags, AVP_NAME_STR)) {
