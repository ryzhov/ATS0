...
class pjsuaJNI {
  ...
  public final static native void pjmedia_codec_param_setting_enc_fmtp_mode_set(long jarg1, pjmedia_codec_param_setting jarg1_, short jarg2);
  public final static native short pjmedia_codec_param_setting_enc_fmtp_mode_get(long jarg1, pjmedia_codec_param_setting jarg1_);
  public final static native void pjmedia_codec_param_setting_dec_fmtp_mode_set(long jarg1, pjmedia_codec_param_setting jarg1_, short jarg2);
  public final static native short pjmedia_codec_param_setting_dec_fmtp_mode_get(long jarg1, pjmedia_codec_param_setting jarg1_);
  ...
  public final static native int PJSUA_PUBLISH_EXPIRATION_get();
  ...
  public final static native void pjsua_media_config_ice_no_host_cands_set(long jarg1, pjsua_media_config jarg1_, int jarg2);
  public final static native int pjsua_media_config_ice_no_host_cands_get(long jarg1, pjsua_media_config jarg1_);
  ...
  public static void SwigDirector_Callback_on_stream_created(Callback self, int call_id, long sess, long stream_idx, long p_port) {
    self.on_stream_created(call_id, new SWIGTYPE_p_pjmedia_session(sess, false), stream_idx, new SWIGTYPE_p_p_pjmedia_port(p_port, false));
  }
  ...
  public static void SwigDirector_Callback_on_pager2(Callback self, int call_id, long from, long to, long contact, long mime_type, long body, long rdata) {
    self.on_pager2(call_id, new pj_str_t(from, false), new pj_str_t(to, false), new pj_str_t(contact, false), new pj_str_t(mime_type, false), new pj_str_t(body, false), new SWIGTYPE_p_pjsip_rx_data(rdata, false));
  }
  ...
  public static void SwigDirector_Callback_on_pager_status2(Callback self, int call_id, long to, long body, int status, long reason, long tdata, long rdata) {
    self.on_pager_status2(call_id, new pj_str_t(to, false), new pj_str_t(body, false), pjsip_status_code.swigToEnum(status), new pj_str_t(reason, false), new SWIGTYPE_p_pjsip_tx_data(tdata, false), new SWIGTYPE_p_pjsip_rx_data(rdata, false));
  }
