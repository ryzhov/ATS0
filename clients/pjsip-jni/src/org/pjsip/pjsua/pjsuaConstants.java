...
public interface pjsuaConstants {
  ...
  public final static int PJMEDIA_CODEC_MAX_FMTP_CNT = pjsuaJNI.PJMEDIA_CODEC_MAX_FMTP_CNT_get();
  ...
  public final static int PJ_PERROR_TITLE_BUF_SIZE = pjsuaJNI.PJ_PERROR_TITLE_BUF_SIZE_get();
  ...
  public final static int PJMEDIA_AUD_DEFAULT_CAPTURE_DEV = pjsuaJNI.PJMEDIA_AUD_DEFAULT_CAPTURE_DEV_get();
  public final static int PJMEDIA_AUD_DEFAULT_PLAYBACK_DEV = pjsuaJNI.PJMEDIA_AUD_DEFAULT_PLAYBACK_DEV_get();
  public final static int PJMEDIA_AUD_INVALID_DEV = pjsuaJNI.PJMEDIA_AUD_INVALID_DEV_get();
