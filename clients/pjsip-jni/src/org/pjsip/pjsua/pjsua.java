...
public class pjsua implements pjsuaConstants {
  ...
  public static pjsip_generic_string_hdr pjsip_generic_string_hdr_create(pj_pool_t pool, pj_str_t hname, pj_str_t hvalue) {
    long cPtr = pjsuaJNI.pjsip_generic_string_hdr_create(pj_pool_t.getCPtr(pool), pool, pj_str_t.getCPtr(hname), hname, pj_str_t.getCPtr(hvalue), hvalue);
    return (cPtr == 0) ? null : new pjsip_generic_string_hdr(cPtr, false);
  }

  public static void pjsip_msg_add_hdr(pjsua_msg_data msg_data, pjsip_generic_string_hdr hdr) {
    pjsuaJNI.pjsip_msg_add_hdr(pjsua_msg_data.getCPtr(msg_data), msg_data, pjsip_generic_string_hdr.getCPtr(hdr), hdr);
  }
  ...
  public static int pj_thread_register(String thread_name, int[] desc, pj_thread_t thread) {
    return pjsuaJNI.pj_thread_register(thread_name, desc, thread);
  }

  public static int pj_thread_is_registered() {
    return pjsuaJNI.pj_thread_is_registered();
  }

  public static void pjsip_generic_string_hdr_init2(pjsip_generic_string_hdr h, pj_str_t hname, pj_str_t hvalue) {
    pjsuaJNI.pjsip_generic_string_hdr_init2(pjsip_generic_string_hdr.getCPtr(h), h, pj_str_t.getCPtr(hname), hname, pj_str_t.getCPtr(hvalue), hvalue);
  }
  ...
  public synchronized static int player_get_port(int id, pjmedia_port p_port) {
    return pjsuaJNI.player_get_port(id, p_port);
  }
  ...
  public synchronized static int recorder_get_port(int id, pjmedia_port p_port) {
    return pjsuaJNI.recorder_get_port(id, p_port);
  }
  ...
  public synchronized static int enum_aud_devs(pjmedia_aud_dev_info info, long[] count) {
    return pjsuaJNI.enum_aud_devs(pjmedia_aud_dev_info.getCPtr(info), info, count);
  }
  ...
  public synchronized static int snd_set_setting(pjmedia_aud_dev_cap cap, byte[] pval, int keep) {
    return pjsuaJNI.snd_set_setting(cap.swigValue(), pval, keep);
  }

  public synchronized static int snd_get_setting(pjmedia_aud_dev_cap cap, byte[] pval) {
    return pjsuaJNI.snd_get_setting(cap.swigValue(), pval);
  }
  ...
  public static int pj_get_os_error() {
    return pjsuaJNI.pj_get_os_error();
  }

  public static void pj_set_os_error(int code) {
    pjsuaJNI.pj_set_os_error(code);
  }

  public static int pj_get_netos_error() {
    return pjsuaJNI.pj_get_netos_error();
  }

  public static void pj_set_netos_error(int code) {
    pjsuaJNI.pj_set_netos_error(code);
  }

  public static pj_str_t pj_strerror(int statcode, String buf, long bufsize) {
    return new pj_str_t(pjsuaJNI.pj_strerror(statcode, buf, bufsize), true);
  }

  public static void pj_perror(int log_level, String sender, int status, String title_fmt) {
    pjsuaJNI.pj_perror(log_level, sender, status, title_fmt);
  }

  public static int pj_register_strerror(int start_code, int err_space, SWIGTYPE_p_f_pj_status_t_p_char_pj_size_t__pj_str_t f) {
    return pjsuaJNI.pj_register_strerror(start_code, err_space, SWIGTYPE_p_f_pj_status_t_p_char_pj_size_t__pj_str_t.getCPtr(f));
  }

  public static void pj_errno_clear_handlers() {
    pjsuaJNI.pj_errno_clear_handlers();
  }

  public synchronized static int pjmedia_snd_port_create(pj_pool_t pool, int rec_id, int play_id, long clock_rate, long channel_count, long samples_per_frame, long bits_per_sample, long options, pjmedia_snd_port p_port) {
    return pjsuaJNI.pjmedia_snd_port_create(pj_pool_t.getCPtr(pool), pool, rec_id, play_id, clock_rate, channel_count, samples_per_frame, bits_per_sample, options, p_port);
  }

  public synchronized static int pjmedia_snd_port_create_rec(pj_pool_t pool, int index, long clock_rate, long channel_count, long samples_per_frame, long bits_per_sample, long options, pjmedia_snd_port p_port) {
    return pjsuaJNI.pjmedia_snd_port_create_rec(pj_pool_t.getCPtr(pool), pool, index, clock_rate, channel_count, samples_per_frame, bits_per_sample, options, p_port);
  }

  public synchronized static int pjmedia_snd_port_create_player(pj_pool_t pool, int index, long clock_rate, long channel_count, long samples_per_frame, long bits_per_sample, long options, pjmedia_snd_port p_port) {
    return pjsuaJNI.pjmedia_snd_port_create_player(pj_pool_t.getCPtr(pool), pool, index, clock_rate, channel_count, samples_per_frame, bits_per_sample, options, p_port);
  }

  public synchronized static int pjmedia_snd_port_create2(pj_pool_t pool, pjmedia_aud_param prm, pjmedia_snd_port p_port) {
    return pjsuaJNI.pjmedia_snd_port_create2(pj_pool_t.getCPtr(pool), pool, pjmedia_aud_param.getCPtr(prm), prm, p_port);
  }

  public synchronized static int pjmedia_snd_port_destroy(pjmedia_snd_port snd_port) {
    return pjsuaJNI.pjmedia_snd_port_destroy(pjmedia_snd_port.getCPtr(snd_port), snd_port);
  }

  public synchronized static SWIGTYPE_p_pjmedia_aud_stream pjmedia_snd_port_get_snd_stream(pjmedia_snd_port snd_port) {
    long cPtr = pjsuaJNI.pjmedia_snd_port_get_snd_stream(pjmedia_snd_port.getCPtr(snd_port), snd_port);
    return (cPtr == 0) ? null : new SWIGTYPE_p_pjmedia_aud_stream(cPtr, false);
  }

  public synchronized static int pjmedia_snd_port_set_ec(pjmedia_snd_port snd_port, pj_pool_t pool, long tail_ms, long options) {
    return pjsuaJNI.pjmedia_snd_port_set_ec(pjmedia_snd_port.getCPtr(snd_port), snd_port, pj_pool_t.getCPtr(pool), pool, tail_ms, options);
  }

  public synchronized static int pjmedia_snd_port_get_ec_tail(pjmedia_snd_port snd_port, SWIGTYPE_p_unsigned_int p_length) {
    return pjsuaJNI.pjmedia_snd_port_get_ec_tail(pjmedia_snd_port.getCPtr(snd_port), snd_port, SWIGTYPE_p_unsigned_int.getCPtr(p_length));
  }

  public synchronized static int pjmedia_snd_port_connect(pjmedia_snd_port snd_port, pjmedia_port port) {
    return pjsuaJNI.pjmedia_snd_port_connect(pjmedia_snd_port.getCPtr(snd_port), snd_port, pjmedia_port.getCPtr(port), port);
  }

  public synchronized static pjmedia_port pjmedia_snd_port_get_port(pjmedia_snd_port snd_port) {
    long cPtr = pjsuaJNI.pjmedia_snd_port_get_port(pjmedia_snd_port.getCPtr(snd_port), snd_port);
    return (cPtr == 0) ? null : new pjmedia_port(cPtr, false);
  }

  public synchronized static int pjmedia_snd_port_disconnect(pjmedia_snd_port snd_port) {
    return pjsuaJNI.pjmedia_snd_port_disconnect(pjmedia_snd_port.getCPtr(snd_port), snd_port);
  }

  public synchronized static String pjmedia_aud_dev_cap_name(pjmedia_aud_dev_cap cap, SWIGTYPE_p_p_char p_desc) {
    return pjsuaJNI.pjmedia_aud_dev_cap_name(cap.swigValue(), SWIGTYPE_p_p_char.getCPtr(p_desc));
  }

  public synchronized static int pjmedia_aud_param_set_cap(pjmedia_aud_param param, pjmedia_aud_dev_cap cap, byte[] pval) {
    return pjsuaJNI.pjmedia_aud_param_set_cap(pjmedia_aud_param.getCPtr(param), param, cap.swigValue(), pval);
  }

  public synchronized static int pjmedia_aud_param_get_cap(pjmedia_aud_param param, pjmedia_aud_dev_cap cap, byte[] pval) {
    return pjsuaJNI.pjmedia_aud_param_get_cap(pjmedia_aud_param.getCPtr(param), param, cap.swigValue(), pval);
  }

  public synchronized static int pjmedia_aud_subsys_init(SWIGTYPE_p_pj_pool_factory pf) {
    return pjsuaJNI.pjmedia_aud_subsys_init(SWIGTYPE_p_pj_pool_factory.getCPtr(pf));
  }

  public synchronized static SWIGTYPE_p_pj_pool_factory pjmedia_aud_subsys_get_pool_factory() {
    long cPtr = pjsuaJNI.pjmedia_aud_subsys_get_pool_factory();
    return (cPtr == 0) ? null : new SWIGTYPE_p_pj_pool_factory(cPtr, false);
  }

  public synchronized static int pjmedia_aud_subsys_shutdown() {
    return pjsuaJNI.pjmedia_aud_subsys_shutdown();
  }

  public synchronized static int pjmedia_aud_register_factory(SWIGTYPE_p_f_p_pj_pool_factory__p_pjmedia_aud_dev_factory adf) {
    return pjsuaJNI.pjmedia_aud_register_factory(SWIGTYPE_p_f_p_pj_pool_factory__p_pjmedia_aud_dev_factory.getCPtr(adf));
  }

  public synchronized static int pjmedia_aud_unregister_factory(SWIGTYPE_p_f_p_pj_pool_factory__p_pjmedia_aud_dev_factory adf) {
    return pjsuaJNI.pjmedia_aud_unregister_factory(SWIGTYPE_p_f_p_pj_pool_factory__p_pjmedia_aud_dev_factory.getCPtr(adf));
  }

  public synchronized static long pjmedia_aud_dev_count() {
    return pjsuaJNI.pjmedia_aud_dev_count();
  }

  public synchronized static int pjmedia_aud_dev_get_info(int id, pjmedia_aud_dev_info info) {
    return pjsuaJNI.pjmedia_aud_dev_get_info(id, pjmedia_aud_dev_info.getCPtr(info), info);
  }

  public synchronized static int pjmedia_aud_dev_lookup(String drv_name, String dev_name, SWIGTYPE_p_int id) {
    return pjsuaJNI.pjmedia_aud_dev_lookup(drv_name, dev_name, SWIGTYPE_p_int.getCPtr(id));
  }

  public synchronized static int pjmedia_aud_dev_default_param(int id, pjmedia_aud_param param) {
    return pjsuaJNI.pjmedia_aud_dev_default_param(id, pjmedia_aud_param.getCPtr(param), param);
  }

  public synchronized static int pjmedia_aud_stream_create(pjmedia_aud_param param, SWIGTYPE_p_f_p_void_p_pjmedia_frame__int rec_cb, SWIGTYPE_p_f_p_void_p_pjmedia_frame__int play_cb, byte[] user_data, SWIGTYPE_p_p_pjmedia_aud_stream p_strm) {
    return pjsuaJNI.pjmedia_aud_stream_create(pjmedia_aud_param.getCPtr(param), param, SWIGTYPE_p_f_p_void_p_pjmedia_frame__int.getCPtr(rec_cb), SWIGTYPE_p_f_p_void_p_pjmedia_frame__int.getCPtr(play_cb), user_data, SWIGTYPE_p_p_pjmedia_aud_stream.getCPtr(p_strm));
  }

  public synchronized static int pjmedia_aud_stream_get_param(SWIGTYPE_p_pjmedia_aud_stream strm, pjmedia_aud_param param) {
    return pjsuaJNI.pjmedia_aud_stream_get_param(SWIGTYPE_p_pjmedia_aud_stream.getCPtr(strm), pjmedia_aud_param.getCPtr(param), param);
  }

  public synchronized static int pjmedia_aud_stream_get_cap(SWIGTYPE_p_pjmedia_aud_stream strm, pjmedia_aud_dev_cap cap, byte[] value) {
    return pjsuaJNI.pjmedia_aud_stream_get_cap(SWIGTYPE_p_pjmedia_aud_stream.getCPtr(strm), cap.swigValue(), value);
  }

  public synchronized static int pjmedia_aud_stream_set_cap(SWIGTYPE_p_pjmedia_aud_stream strm, pjmedia_aud_dev_cap cap, byte[] value) {
    return pjsuaJNI.pjmedia_aud_stream_set_cap(SWIGTYPE_p_pjmedia_aud_stream.getCPtr(strm), cap.swigValue(), value);
  }

  public synchronized static int pjmedia_aud_stream_start(SWIGTYPE_p_pjmedia_aud_stream strm) {
    return pjsuaJNI.pjmedia_aud_stream_start(SWIGTYPE_p_pjmedia_aud_stream.getCPtr(strm));
  }

  public synchronized static int pjmedia_aud_stream_stop(SWIGTYPE_p_pjmedia_aud_stream strm) {
    return pjsuaJNI.pjmedia_aud_stream_stop(SWIGTYPE_p_pjmedia_aud_stream.getCPtr(strm));
  }

  public synchronized static int pjmedia_aud_stream_destroy(SWIGTYPE_p_pjmedia_aud_stream strm) {
    return pjsuaJNI.pjmedia_aud_stream_destroy(SWIGTYPE_p_pjmedia_aud_stream.getCPtr(strm));
  }

  public synchronized static int pjmedia_tonegen_create(pj_pool_t pool, long clock_rate, long channel_count, long samples_per_frame, long bits_per_sample, long options, pjmedia_port p_port) {
    return pjsuaJNI.pjmedia_tonegen_create(pj_pool_t.getCPtr(pool), pool, clock_rate, channel_count, samples_per_frame, bits_per_sample, options, p_port);
  }

  public synchronized static int pjmedia_tonegen_create2(pj_pool_t pool, pj_str_t name, long clock_rate, long channel_count, long samples_per_frame, long bits_per_sample, long options, pjmedia_port p_port) {
    return pjsuaJNI.pjmedia_tonegen_create2(pj_pool_t.getCPtr(pool), pool, pj_str_t.getCPtr(name), name, clock_rate, channel_count, samples_per_frame, bits_per_sample, options, p_port);
  }

  public synchronized static int pjmedia_tonegen_is_busy(pjmedia_port tonegen) {
    return pjsuaJNI.pjmedia_tonegen_is_busy(pjmedia_port.getCPtr(tonegen), tonegen);
  }

  public synchronized static int pjmedia_tonegen_stop(pjmedia_port tonegen) {
    return pjsuaJNI.pjmedia_tonegen_stop(pjmedia_port.getCPtr(tonegen), tonegen);
  }

  public synchronized static int pjmedia_tonegen_rewind(pjmedia_port tonegen) {
    return pjsuaJNI.pjmedia_tonegen_rewind(pjmedia_port.getCPtr(tonegen), tonegen);
  }

  public synchronized static int pjmedia_tonegen_play(pjmedia_port tonegen, long count, pjmedia_tone_desc[] tones, long options) {
  ...
  public synchronized static int pjmedia_tonegen_play_digits(pjmedia_port tonegen, long count, pjmedia_tone_digit digits, long options) {
    return pjsuaJNI.pjmedia_tonegen_play_digits(pjmedia_port.getCPtr(tonegen), tonegen, count, pjmedia_tone_digit.getCPtr(digits), digits, options);
  }

  public synchronized static int pjmedia_tonegen_get_digit_map(pjmedia_port tonegen, SWIGTYPE_p_p_pjmedia_tone_digit_map m) {
    return pjsuaJNI.pjmedia_tonegen_get_digit_map(pjmedia_port.getCPtr(tonegen), tonegen, SWIGTYPE_p_p_pjmedia_tone_digit_map.getCPtr(m));
  }

  public synchronized static int pjmedia_tonegen_set_digit_map(pjmedia_port tonegen, pjmedia_tone_digit_map m) {
    return pjsuaJNI.pjmedia_tonegen_set_digit_map(pjmedia_port.getCPtr(tonegen), tonegen, pjmedia_tone_digit_map.getCPtr(m), m);
  }
