...
public class Callback {
  ...
  public void on_call_state_extended(int call_id, pjsip_event e, pjsua_call_info info) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_call_state_extended(swigCPtr, this, call_id, pjsip_event.getCPtr(e), e, pjsua_call_info.getCPtr(info), info); else pjsuaJNI.Callback_on_call_state_extendedSwigExplicitCallback(swigCPtr, this, call_id, pjsip_event.getCPtr(e), e, pjsua_call_info.getCPtr(info), info);
  }
  ...
  public void on_stream_created(int call_id, SWIGTYPE_p_pjmedia_session sess, long stream_idx, SWIGTYPE_p_p_pjmedia_port pm_port) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_stream_created(swigCPtr, this, call_id, SWIGTYPE_p_pjmedia_session.getCPtr(sess), stream_idx, SWIGTYPE_p_p_pjmedia_port.getCPtr(pm_port)); else pjsuaJNI.Callback_on_stream_createdSwigExplicitCallback(swigCPtr, this, call_id, SWIGTYPE_p_pjmedia_session.getCPtr(sess), stream_idx, SWIGTYPE_p_p_pjmedia_port.getCPtr(pm_port));
  }
  ...
  public void on_reg_state2(int acc_id, pjsua_reg_info info) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_reg_state2(swigCPtr, this, acc_id, pjsua_reg_info.getCPtr(info), info); else pjsuaJNI.Callback_on_reg_state2SwigExplicitCallback(swigCPtr, this, acc_id, pjsua_reg_info.getCPtr(info), info);
  }

  public void on_incoming_subscribe(int acc_id, SWIGTYPE_p_pjsua_srv_pres srv_pres, int buddy_id, pj_str_t from, SWIGTYPE_p_pjsip_rx_data rdata, SWIGTYPE_p_pjsip_status_code code, pj_str_t reason, pjsua_msg_data msg_data) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_incoming_subscribe(swigCPtr, this, acc_id, SWIGTYPE_p_pjsua_srv_pres.getCPtr(srv_pres), buddy_id, pj_str_t.getCPtr(from), from, SWIGTYPE_p_pjsip_rx_data.getCPtr(rdata), SWIGTYPE_p_pjsip_status_code.getCPtr(code), pj_str_t.getCPtr(reason), reason, pjsua_msg_data.getCPtr(msg_data), msg_data); else pjsuaJNI.Callback_on_incoming_subscribeSwigExplicitCallback(swigCPtr, this, acc_id, SWIGTYPE_p_pjsua_srv_pres.getCPtr(srv_pres), buddy_id, pj_str_t.getCPtr(from), from, SWIGTYPE_p_pjsip_rx_data.getCPtr(rdata), SWIGTYPE_p_pjsip_status_code.getCPtr(code), pj_str_t.getCPtr(reason), reason, pjsua_msg_data.getCPtr(msg_data), msg_data);
  }

  public void on_srv_subscribe_state(int acc_id, SWIGTYPE_p_pjsua_srv_pres srv_pres, pj_str_t remote_uri, SWIGTYPE_p_pjsip_evsub_state state, pjsip_event event) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_srv_subscribe_state(swigCPtr, this, acc_id, SWIGTYPE_p_pjsua_srv_pres.getCPtr(srv_pres), pj_str_t.getCPtr(remote_uri), remote_uri, SWIGTYPE_p_pjsip_evsub_state.getCPtr(state), pjsip_event.getCPtr(event), event); else pjsuaJNI.Callback_on_srv_subscribe_stateSwigExplicitCallback(swigCPtr, this, acc_id, SWIGTYPE_p_pjsua_srv_pres.getCPtr(srv_pres), pj_str_t.getCPtr(remote_uri), remote_uri, SWIGTYPE_p_pjsip_evsub_state.getCPtr(state), pjsip_event.getCPtr(event), event);
  }
  ...
  public void on_buddy_evsub_state(int buddy_id, SWIGTYPE_p_pjsip_evsub sub, pjsip_event event) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_buddy_evsub_state(swigCPtr, this, buddy_id, SWIGTYPE_p_pjsip_evsub.getCPtr(sub), pjsip_event.getCPtr(event), event); else pjsuaJNI.Callback_on_buddy_evsub_stateSwigExplicitCallback(swigCPtr, this, buddy_id, SWIGTYPE_p_pjsip_evsub.getCPtr(sub), pjsip_event.getCPtr(event), event);
  }
  ...
  public void on_pager_status2(int call_id, pj_str_t to, pj_str_t body, pjsip_status_code status, pj_str_t reason, SWIGTYPE_p_pjsip_tx_data tdata, SWIGTYPE_p_pjsip_rx_data rdata, int acc_id) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_pager_status2(swigCPtr, this, call_id, pj_str_t.getCPtr(to), to, pj_str_t.getCPtr(body), body, status.swigValue(), pj_str_t.getCPtr(reason), reason, SWIGTYPE_p_pjsip_tx_data.getCPtr(tdata), SWIGTYPE_p_pjsip_rx_data.getCPtr(rdata), acc_id); else pjsuaJNI.Callback_on_pager_status2SwigExplicitCallback(swigCPtr, this, call_id, pj_str_t.getCPtr(to), to, pj_str_t.getCPtr(body), body, status.swigValue(), pj_str_t.getCPtr(reason), reason, SWIGTYPE_p_pjsip_tx_data.getCPtr(tdata), SWIGTYPE_p_pjsip_rx_data.getCPtr(rdata), acc_id);
  }
  ...
  public void on_typing2(int call_id, pj_str_t from, pj_str_t to, pj_str_t contact, int is_typing, SWIGTYPE_p_pjsip_rx_data rdata, int acc_id) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_typing2(swigCPtr, this, call_id, pj_str_t.getCPtr(from), from, pj_str_t.getCPtr(to), to, pj_str_t.getCPtr(contact), contact, is_typing, SWIGTYPE_p_pjsip_rx_data.getCPtr(rdata), acc_id); else pjsuaJNI.Callback_on_typing2SwigExplicitCallback(swigCPtr, this, call_id, pj_str_t.getCPtr(from), from, pj_str_t.getCPtr(to), to, pj_str_t.getCPtr(contact), contact, is_typing, SWIGTYPE_p_pjsip_rx_data.getCPtr(rdata), acc_id);
  }
  ...
  public pjsip_redirect_op on_call_redirected(int call_id, SWIGTYPE_p_pjsip_uri target, pjsip_event e) {
    return pjsip_redirect_op.swigToEnum((getClass() == Callback.class) ? pjsuaJNI.Callback_on_call_redirected(swigCPtr, this, call_id, SWIGTYPE_p_pjsip_uri.getCPtr(target), pjsip_event.getCPtr(e), e) : pjsuaJNI.Callback_on_call_redirectedSwigExplicitCallback(swigCPtr, this, call_id, SWIGTYPE_p_pjsip_uri.getCPtr(target), pjsip_event.getCPtr(e), e));
  }

  public void on_mwi_info(int acc_id, pjsua_mwi_info mwi_info) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_mwi_info(swigCPtr, this, acc_id, pjsua_mwi_info.getCPtr(mwi_info), mwi_info); else pjsuaJNI.Callback_on_mwi_infoSwigExplicitCallback(swigCPtr, this, acc_id, pjsua_mwi_info.getCPtr(mwi_info), mwi_info);
  }

  public void on_ice_transport_error(int index, SWIGTYPE_p_pj_ice_strans_op op, int status) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_ice_transport_error(swigCPtr, this, index, SWIGTYPE_p_pj_ice_strans_op.getCPtr(op), status); else pjsuaJNI.Callback_on_ice_transport_errorSwigExplicitCallback(swigCPtr, this, index, SWIGTYPE_p_pj_ice_strans_op.getCPtr(op), status);
  }
