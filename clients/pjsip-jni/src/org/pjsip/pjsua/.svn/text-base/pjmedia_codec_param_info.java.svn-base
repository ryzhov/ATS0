...
public class pjmedia_codec_param_info {
  ...
  public void setFmt_id(pjmedia_format_id value) {
    pjsuaJNI.pjmedia_codec_param_info_fmt_id_set(swigCPtr, this, value.swigValue());
  }

  public pjmedia_format_id getFmt_id() {
    return pjmedia_format_id.swigToEnum(pjsuaJNI.pjmedia_codec_param_info_fmt_id_get(swigCPtr, this));
  }
