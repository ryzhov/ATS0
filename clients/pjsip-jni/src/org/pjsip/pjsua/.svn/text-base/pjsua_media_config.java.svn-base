...
public class pjsua_media_config {
  ...
  public void setTurn_auth_cred(pj_stun_auth_cred value) {
    pjsuaJNI.pjsua_media_config_turn_auth_cred_set(swigCPtr, this, pj_stun_auth_cred.getCPtr(value), value);
  }

  public pj_stun_auth_cred getTurn_auth_cred() {
    long cPtr = pjsuaJNI.pjsua_media_config_turn_auth_cred_get(swigCPtr, this);
    return (cPtr == 0) ? null : new pj_stun_auth_cred(cPtr, false);
  }
