...
public class pjmedia_codec_param_setting {
  ...
  public void setEnc_fmtp(pjmedia_codec_fmtp value) {
    pjsuaJNI.pjmedia_codec_param_setting_enc_fmtp_set(swigCPtr, this, pjmedia_codec_fmtp.getCPtr(value), value);
  }

  public pjmedia_codec_fmtp getEnc_fmtp() {
    long cPtr = pjsuaJNI.pjmedia_codec_param_setting_enc_fmtp_get(swigCPtr, this);
    return (cPtr == 0) ? null : new pjmedia_codec_fmtp(cPtr, false);
  }

  public void setDec_fmtp(pjmedia_codec_fmtp value) {
    pjsuaJNI.pjmedia_codec_param_setting_dec_fmtp_set(swigCPtr, this, pjmedia_codec_fmtp.getCPtr(value), value);
  }

  public pjmedia_codec_fmtp getDec_fmtp() {
    long cPtr = pjsuaJNI.pjmedia_codec_param_setting_dec_fmtp_get(swigCPtr, this);
    return (cPtr == 0) ? null : new pjmedia_codec_fmtp(cPtr, false);
  }
