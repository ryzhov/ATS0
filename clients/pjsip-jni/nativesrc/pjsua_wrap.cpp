...
typedef struct {
	...
	} pj_stun_auth_cred_data_dyn_cred;
...
typedef struct {
	...
	} pj_stun_auth_cred_data_static_cred;
...
void SwigDirector_Callback::on_call_state_extended(pjsua_call_id call_id, pjsip_event *e, pjsua_call_info *info) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jcall_id  ;
  ...
  if (!swig_override[1]) {
    Callback::on_call_state_extended(call_id,e,info);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jcall_id = (jint) call_id;
    *((pjsip_event **)&je) = (pjsip_event *) e; 
    *((pjsua_call_info **)&jinfo) = (pjsua_call_info *) info; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[1], swigjobj, jcall_id, je, jinfo);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_incoming_call(pjsua_acc_id acc_id, pjsua_call_id call_id, pjsip_rx_data *rdata) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjsip_rx_data **)&jrdata) = (pjsip_rx_data *) rdata; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[2], swigjobj, jacc_id, jcall_id, jrdata);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_call_tsx_state(pjsua_call_id call_id, pjsip_transaction *tsx, pjsip_event *e) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjsip_event **)&je) = (pjsip_event *) e; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[3], swigjobj, jcall_id, jtsx, je);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_call_media_state(pjsua_call_id call_id) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jcall_id = (jint) call_id;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[4], swigjobj, jcall_id);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_stream_created(pjsua_call_id call_id, pjmedia_session *sess, unsigned int stream_idx, pjmedia_port **pm_port) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jcall_id  ;
  ...
  if (!swig_override[5]) {
    Callback::on_stream_created(call_id,sess,stream_idx,pm_port);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjmedia_port ***)&jpm_port) = (pjmedia_port **) pm_port; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[5], swigjobj, jcall_id, jsess, jstream_idx, jpm_port);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_stream_destroyed(pjsua_call_id call_id, pjmedia_session *sess, unsigned int stream_idx) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjmedia_session **)&jsess) = (pjmedia_session *) sess; 
    jstream_idx = (jlong) stream_idx;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[6], swigjobj, jcall_id, jsess, jstream_idx);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_reg_state2(pjsua_acc_id acc_id, pjsua_reg_info *info) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jacc_id  ;
  ...
  if (!swig_override[13]) {
    Callback::on_reg_state2(acc_id,info);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jacc_id = (jint) acc_id;
    *((pjsua_reg_info **)&jinfo) = (pjsua_reg_info *) info; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[13], swigjobj, jacc_id, jinfo);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_incoming_subscribe(pjsua_acc_id acc_id, pjsua_srv_pres *srv_pres, pjsua_buddy_id buddy_id, pj_str_t const *from, pjsip_rx_data *rdata, pjsip_status_code *code, pj_str_t *reason, pjsua_msg_data *msg_data) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjsua_msg_data **)&jmsg_data) = (pjsua_msg_data *) msg_data; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[14], swigjobj, jacc_id, jsrv_pres, jbuddy_id, jfrom, jrdata, jcode, jreason, jmsg_data);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_srv_subscribe_state(pjsua_acc_id acc_id, pjsua_srv_pres *srv_pres, pj_str_t const *remote_uri, pjsip_evsub_state state, pjsip_event *event) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jacc_id  ;
  ...
  if (!swig_override[15]) {
    Callback::on_srv_subscribe_state(acc_id,srv_pres,remote_uri,state,event);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jacc_id = (jint) acc_id;
    *((pjsua_srv_pres **)&jsrv_pres) = (pjsua_srv_pres *) srv_pres; 
    *((pj_str_t **)&jremote_uri) = (pj_str_t *) remote_uri; 
    jstate = 0;
    *((pjsip_evsub_state **)&jstate) = &state; 
    *((pjsip_event **)&jevent) = (pjsip_event *) event; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[15], swigjobj, jacc_id, jsrv_pres, jremote_uri, jstate, jevent);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_buddy_state(pjsua_buddy_id buddy_id) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jbuddy_id = (jint) buddy_id;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[16], swigjobj, jbuddy_id);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_buddy_evsub_state(pjsua_buddy_id buddy_id, pjsip_evsub *sub, pjsip_event *event) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jbuddy_id  ;
  ...
  if (!swig_override[17]) {
    Callback::on_buddy_evsub_state(buddy_id,sub,event);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jbuddy_id = (jint) buddy_id;
    *((pjsip_evsub **)&jsub) = (pjsip_evsub *) sub; 
    *((pjsip_event **)&jevent) = (pjsip_event *) event; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[17], swigjobj, jbuddy_id, jsub, jevent);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_pager(pjsua_call_id call_id, pj_str_t const *from, pj_str_t const *to, pj_str_t const *contact, pj_str_t const *mime_type, pj_str_t const *body) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pj_str_t **)&jbody) = (pj_str_t *) body; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[18], swigjobj, jcall_id, jfrom, jto, jcontact, jmime_type, jbody);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_pager2(pjsua_call_id call_id, pj_str_t const *from, pj_str_t const *to, pj_str_t const *contact, pj_str_t const *mime_type, pj_str_t const *body, pjsip_rx_data *rdata, pjsua_acc_id acc_id) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jcall_id  ;
  ...
  if (!swig_override[19]) {
    Callback::on_pager2(call_id,from,to,contact,mime_type,body,rdata,acc_id);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjsip_rx_data **)&jrdata) = (pjsip_rx_data *) rdata; 
    jacc_id = (jint) acc_id;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[19], swigjobj, jcall_id, jfrom, jto, jcontact, jmime_type, jbody, jrdata, jacc_id);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_pager_status(pjsua_call_id call_id, pj_str_t const *to, pj_str_t const *body, pjsip_status_code status, pj_str_t const *reason) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pj_str_t **)&jbody) = (pj_str_t *) body; 
    jstatus = (jint) status;
    *((pj_str_t **)&jreason) = (pj_str_t *) reason; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[20], swigjobj, jcall_id, jto, jbody, jstatus, jreason);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_pager_status2(pjsua_call_id call_id, pj_str_t const *to, pj_str_t const *body, pjsip_status_code status, pj_str_t const *reason, pjsip_tx_data *tdata, pjsip_rx_data *rdata, pjsua_acc_id acc_id) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jcall_id  ;
  ...
  if (!swig_override[21]) {
    Callback::on_pager_status2(call_id,to,body,status,reason,tdata,rdata,acc_id);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjsip_rx_data **)&jrdata) = (pjsip_rx_data *) rdata; 
    jacc_id = (jint) acc_id;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[21], swigjobj, jcall_id, jto, jbody, jstatus, jreason, jtdata, jrdata, jacc_id);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_typing(pjsua_call_id call_id, pj_str_t const *from, pj_str_t const *to, pj_str_t const *contact, pj_bool_t is_typing) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pj_str_t **)&jcontact) = (pj_str_t *) contact; 
    ...
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[22], swigjobj, jcall_id, jfrom, jto, jcontact, jis_typing);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_typing2(pjsua_call_id call_id, pj_str_t const *from, pj_str_t const *to, pj_str_t const *contact, pj_bool_t is_typing, pjsip_rx_data *rdata, pjsua_acc_id acc_id) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jcall_id  ;
  ...
  if (!swig_override[23]) {
    Callback::on_typing2(call_id,from,to,contact,is_typing,rdata,acc_id);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjsip_rx_data **)&jrdata) = (pjsip_rx_data *) rdata; 
    jacc_id = (jint) acc_id;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[23], swigjobj, jcall_id, jfrom, jto, jcontact, jis_typing, jrdata, jacc_id);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_nat_detect(pj_stun_nat_detect_result const *res) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    *((pj_stun_nat_detect_result **)&jres) = (pj_stun_nat_detect_result *) res; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[24], swigjobj, jres);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
pjsip_redirect_op SwigDirector_Callback::on_call_redirected(pjsua_call_id call_id, pjsip_uri const *target, pjsip_event const *e) {
  ...
  if (!swig_override[25]) {
    return Callback::on_call_redirected(call_id,target,e);
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jcall_id = (jint) call_id;
    *((pjsip_uri **)&jtarget) = (pjsip_uri *) target; 
    *((pjsip_event **)&je) = (pjsip_event *) e; 
    jresult = (jint) jenv->CallStaticIntMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[25], swigjobj, jcall_id, jtarget, je);
...
void SwigDirector_Callback::on_mwi_info(pjsua_acc_id acc_id, pjsua_mwi_info *mwi_info) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jacc_id  ;
  ...
  if (!swig_override[26]) {
    Callback::on_mwi_info(acc_id,mwi_info);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jacc_id = (jint) acc_id;
    *((pjsua_mwi_info **)&jmwi_info) = (pjsua_mwi_info *) mwi_info; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[26], swigjobj, jacc_id, jmwi_info);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::on_ice_transport_error(int index, pj_ice_strans_op op, pj_status_t status) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jint jindex  ;
  ...
  if (!swig_override[27]) {
    Callback::on_ice_transport_error(index,op,status);
    return;
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jindex = (jint) index;
    jop = 0;
    *((pj_ice_strans_op **)&jop) = &op; 
    jstatus = (jint) status;
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[27], swigjobj, jindex, jop, jstatus);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
void SwigDirector_Callback::swig_connect_director(JNIEnv *jenv, jobject jself, jclass jcls, bool swig_mem_own, bool weak_global) {
  static struct {
    ...
    {
      "on_call_state_extended", "(ILorg/pjsip/pjsua/pjsip_event;Lorg/pjsip/pjsua/pjsua_call_info;)V", NULL 
    },
    {
    ...
    {
      "on_reg_state2", "(ILorg/pjsip/pjsua/pjsua_reg_info;)V", NULL 
    },
    {
    ...
    {
      "on_srv_subscribe_state", "(ILorg/pjsip/pjsua/SWIGTYPE_p_pjsua_srv_pres;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/SWIGTYPE_p_pjsip_evsub_state;Lorg/pjsip/pjsua/pjsip_event;)V", NULL 
    },
    {
      "on_buddy_state", "(I)V", NULL 
    },
    {
      "on_buddy_evsub_state", "(ILorg/pjsip/pjsua/SWIGTYPE_p_pjsip_evsub;Lorg/pjsip/pjsua/pjsip_event;)V", NULL 
    },
    {
    ...
    {
      "on_pager2", "(ILorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/SWIGTYPE_p_pjsip_rx_data;I)V", NULL 
    },
    {
    ...
    {
      "on_pager_status2", "(ILorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pjsip_status_code;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/SWIGTYPE_p_pjsip_tx_data;Lorg/pjsip/pjsua/SWIGTYPE_p_pjsip_rx_data;I)V", NULL 
    },
    {
      "on_typing", "(ILorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;I)V", NULL 
    },
    {
      "on_typing2", "(ILorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;Lorg/pjsip/pjsua/pj_str_t;ILorg/pjsip/pjsua/SWIGTYPE_p_pjsip_rx_data;I)V", NULL 
    },
    {
      "on_nat_detect", "(Lorg/pjsip/pjsua/SWIGTYPE_p_pj_stun_nat_detect_result;)V", NULL 
    },
    {
      "on_call_redirected", "(ILorg/pjsip/pjsua/SWIGTYPE_p_pjsip_uri;Lorg/pjsip/pjsua/pjsip_event;)Lorg/pjsip/pjsua/pjsip_redirect_op;", NULL 
    },
    {
      "on_mwi_info", "(ILorg/pjsip/pjsua/pjsua_mwi_info;)V", NULL 
    },
    {
      "on_ice_transport_error", "(ILorg/pjsip/pjsua/SWIGTYPE_p_pj_ice_strans_op;I)V", NULL 
    }
  };
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1THREAD_1DESC_1SIZE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1call_1state_1extended(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pjsip_event *arg3 = (pjsip_event *) 0 ;
  pjsua_call_info *arg4 = (pjsua_call_info *) 0 ;
  ...
  arg2 = (pjsua_call_id)jarg2; 
  arg3 = *(pjsip_event **)&jarg3; 
  arg4 = *(pjsua_call_info **)&jarg4; 
  (arg1)->on_call_state_extended(arg2,arg3,arg4);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1call_1state_1extendedSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pjsip_event *arg3 = (pjsip_event *) 0 ;
  pjsua_call_info *arg4 = (pjsua_call_info *) 0 ;
  ...
  arg3 = *(pjsip_event **)&jarg3; 
  arg4 = *(pjsua_call_info **)&jarg4; 
  (arg1)->Callback::on_call_state_extended(arg2,arg3,arg4);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1reg_1state2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_acc_id arg2 ;
  pjsua_reg_info *arg3 = (pjsua_reg_info *) 0 ;
  ...
  arg1 = *(Callback **)&jarg1; 
  arg2 = (pjsua_acc_id)jarg2; 
  arg3 = *(pjsua_reg_info **)&jarg3; 
  (arg1)->on_reg_state2(arg2,arg3);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1reg_1state2SwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_acc_id arg2 ;
  pjsua_reg_info *arg3 = (pjsua_reg_info *) 0 ;
  ...
  arg2 = (pjsua_acc_id)jarg2; 
  arg3 = *(pjsua_reg_info **)&jarg3; 
  (arg1)->Callback::on_reg_state2(arg2,arg3);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1srv_1subscribe_1state(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jobject jarg4_, jlong jarg5, jlong jarg6, jobject jarg6_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_acc_id arg2 ;
  pjsua_srv_pres *arg3 = (pjsua_srv_pres *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  pjsip_evsub_state arg5 ;
  pjsip_event *arg6 = (pjsip_event *) 0 ;
  pjsip_evsub_state *argp5 ;
  ...
  arg3 = *(pjsua_srv_pres **)&jarg3; 
  arg4 = *(pj_str_t **)&jarg4; 
  argp5 = *(pjsip_evsub_state **)&jarg5; 
  if (!argp5) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "Attempt to dereference null pjsip_evsub_state");
    return ;
  }
  arg5 = *argp5; 
  arg6 = *(pjsip_event **)&jarg6; 
  (arg1)->on_srv_subscribe_state(arg2,arg3,(pj_str_t const *)arg4,arg5,arg6);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1srv_1subscribe_1stateSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jobject jarg4_, jlong jarg5, jlong jarg6, jobject jarg6_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_acc_id arg2 ;
  pjsua_srv_pres *arg3 = (pjsua_srv_pres *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  ...
  arg5 = *argp5; 
  arg6 = *(pjsip_event **)&jarg6; 
  (arg1)->Callback::on_srv_subscribe_state(arg2,arg3,(pj_str_t const *)arg4,arg5,arg6);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1buddy_1evsub_1state(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jobject jarg4_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_buddy_id arg2 ;
  pjsip_evsub *arg3 = (pjsip_evsub *) 0 ;
  pjsip_event *arg4 = (pjsip_event *) 0 ;
  ...
  arg1 = *(Callback **)&jarg1; 
  arg2 = (pjsua_buddy_id)jarg2; 
  arg3 = *(pjsip_evsub **)&jarg3; 
  arg4 = *(pjsip_event **)&jarg4; 
  (arg1)->on_buddy_evsub_state(arg2,arg3,arg4);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1buddy_1evsub_1stateSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jobject jarg4_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_buddy_id arg2 ;
  pjsip_evsub *arg3 = (pjsip_evsub *) 0 ;
  pjsip_event *arg4 = (pjsip_event *) 0 ;
  ...
  arg3 = *(pjsip_evsub **)&jarg3; 
  arg4 = *(pjsip_event **)&jarg4; 
  (arg1)->Callback::on_buddy_evsub_state(arg2,arg3,arg4);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1pager2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_, jlong jarg5, jobject jarg5_, jlong jarg6, jobject jarg6_, jlong jarg7, jobject jarg7_, jlong jarg8, jint jarg9) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  ...
  arg9 = (pjsua_acc_id)jarg9; 
  (arg1)->on_pager2(arg2,(pj_str_t const *)arg3,(pj_str_t const *)arg4,(pj_str_t const *)arg5,(pj_str_t const *)arg6,(pj_str_t const *)arg7,arg8,arg9);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1pager2SwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_, jlong jarg5, jobject jarg5_, jlong jarg6, jobject jarg6_, jlong jarg7, jobject jarg7_, jlong jarg8, jint jarg9) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  ...
  arg8 = *(pjsip_rx_data **)&jarg8; 
  arg9 = (pjsua_acc_id)jarg9; 
  (arg1)->Callback::on_pager2(arg2,(pj_str_t const *)arg3,(pj_str_t const *)arg4,(pj_str_t const *)arg5,(pj_str_t const *)arg6,(pj_str_t const *)arg7,arg8,arg9);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1pager_1status2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_, jint jarg5, jlong jarg6, jobject jarg6_, jlong jarg7, jlong jarg8, jint jarg9) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  ...
  arg8 = *(pjsip_rx_data **)&jarg8; 
  arg9 = (pjsua_acc_id)jarg9; 
  (arg1)->on_pager_status2(arg2,(pj_str_t const *)arg3,(pj_str_t const *)arg4,arg5,(pj_str_t const *)arg6,arg7,arg8,arg9);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1pager_1status2SwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_, jint jarg5, jlong jarg6, jobject jarg6_, jlong jarg7, jlong jarg8, jint jarg9) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  ...
  arg8 = *(pjsip_rx_data **)&jarg8; 
  arg9 = (pjsua_acc_id)jarg9; 
  (arg1)->Callback::on_pager_status2(arg2,(pj_str_t const *)arg3,(pj_str_t const *)arg4,arg5,(pj_str_t const *)arg6,arg7,arg8,arg9);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1typing2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_, jlong jarg5, jobject jarg5_, jint jarg6, jlong jarg7, jint jarg8) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  pj_str_t *arg5 = (pj_str_t *) 0 ;
  pj_bool_t arg6 ;
  pjsip_rx_data *arg7 = (pjsip_rx_data *) 0 ;
  pjsua_acc_id arg8 ;
  ...
  arg5 = *(pj_str_t **)&jarg5; 
  arg6 = (pj_bool_t)jarg6; 
  arg7 = *(pjsip_rx_data **)&jarg7; 
  arg8 = (pjsua_acc_id)jarg8; 
  (arg1)->on_typing2(arg2,(pj_str_t const *)arg3,(pj_str_t const *)arg4,(pj_str_t const *)arg5,arg6,arg7,arg8);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1typing2SwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_, jlong jarg4, jobject jarg4_, jlong jarg5, jobject jarg5_, jint jarg6, jlong jarg7, jint jarg8) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  pj_str_t *arg4 = (pj_str_t *) 0 ;
  ...
  arg7 = *(pjsip_rx_data **)&jarg7; 
  arg8 = (pjsua_acc_id)jarg8; 
  (arg1)->Callback::on_typing2(arg2,(pj_str_t const *)arg3,(pj_str_t const *)arg4,(pj_str_t const *)arg5,arg6,arg7,arg8);
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1call_1redirected(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jobject jarg4_) {
  jint jresult = 0 ;
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pjsip_uri *arg3 = (pjsip_uri *) 0 ;
  pjsip_event *arg4 = (pjsip_event *) 0 ;
  ...
  arg1 = *(Callback **)&jarg1; 
  arg2 = (pjsua_call_id)jarg2; 
  arg3 = *(pjsip_uri **)&jarg3; 
  arg4 = *(pjsip_event **)&jarg4; 
  result = (pjsip_redirect_op)(arg1)->on_call_redirected(arg2,(pjsip_uri const *)arg3,(pjsip_event const *)arg4);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1call_1redirectedSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jobject jarg4_) {
  jint jresult = 0 ;
  Callback *arg1 = (Callback *) 0 ;
  pjsua_call_id arg2 ;
  pjsip_uri *arg3 = (pjsip_uri *) 0 ;
  ...
  arg3 = *(pjsip_uri **)&jarg3; 
  arg4 = *(pjsip_event **)&jarg4; 
  result = (pjsip_redirect_op)(arg1)->Callback::on_call_redirected(arg2,(pjsip_uri const *)arg3,(pjsip_event const *)arg4);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1mwi_1info(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_acc_id arg2 ;
  pjsua_mwi_info *arg3 = (pjsua_mwi_info *) 0 ;
  ...
  arg1 = *(Callback **)&jarg1; 
  arg2 = (pjsua_acc_id)jarg2; 
  arg3 = *(pjsua_mwi_info **)&jarg3; 
  (arg1)->on_mwi_info(arg2,arg3);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1mwi_1infoSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_) {
  Callback *arg1 = (Callback *) 0 ;
  pjsua_acc_id arg2 ;
  pjsua_mwi_info *arg3 = (pjsua_mwi_info *) 0 ;
  ...
  arg2 = (pjsua_acc_id)jarg2; 
  arg3 = *(pjsua_mwi_info **)&jarg3; 
  (arg1)->Callback::on_mwi_info(arg2,arg3);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1ice_1transport_1error(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jint jarg4) {
  Callback *arg1 = (Callback *) 0 ;
  int arg2 ;
  pj_ice_strans_op arg3 ;
  pj_status_t arg4 ;
  pj_ice_strans_op *argp3 ;
  ...
  arg1 = *(Callback **)&jarg1; 
  arg2 = (int)jarg2; 
  argp3 = *(pj_ice_strans_op **)&jarg3; 
  if (!argp3) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "Attempt to dereference null pj_ice_strans_op");
    return ;
  }
  arg3 = *argp3; 
  arg4 = (pj_status_t)jarg4; 
  (arg1)->on_ice_transport_error(arg2,arg3,arg4);
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_Callback_1on_1ice_1transport_1errorSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jint jarg4) {
  Callback *arg1 = (Callback *) 0 ;
  int arg2 ;
  pj_ice_strans_op arg3 ;
  pj_status_t arg4 ;
  ...
  arg3 = *argp3; 
  arg4 = (pj_status_t)jarg4; 
  (arg1)->Callback::on_ice_transport_error(arg2,arg3,arg4);
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1L16_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_L16;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1PCM_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_PCM;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1PCMA_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_PCMA;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1ALAW_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_ALAW;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1PCMU_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_PCMU;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1ULAW_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_ULAW;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1AMR_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_AMR;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1G729_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_G729;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1FORMAT_1ILBC_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_format_id result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_format_id)PJMEDIA_FORMAT_ILBC;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1CODEC_1MAX_1FMTP_1CNT_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1cnt_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jshort jarg2) {
  ...
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_codec_fmtp **)&jarg1; 
  arg2 = (pj_uint8_t)jarg2; 
  if (arg1) (arg1)->cnt = arg2;
}


SWIGEXPORT jshort JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1cnt_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jshort jresult = 0 ;
  pjmedia_codec_fmtp *arg1 = (pjmedia_codec_fmtp *) 0 ;
  pj_uint8_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_codec_fmtp **)&jarg1; 
  result = (pj_uint8_t) ((arg1)->cnt);
  jresult = (jshort)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1param_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_codec_fmtp *arg1 = (pjmedia_codec_fmtp *) 0 ;
  pjmedia_codec_fmtp_param *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_codec_fmtp **)&jarg1; 
  result = (pjmedia_codec_fmtp_param *)(pjmedia_codec_fmtp_param *) ((arg1)->param);
  *(pjmedia_codec_fmtp_param **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjmedia_1codec_1fmtp(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjmedia_codec_fmtp *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_codec_fmtp *)new pjmedia_codec_fmtp();
  *(pjmedia_codec_fmtp **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjmedia_1codec_1fmtp(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjmedia_codec_fmtp *arg1 = (pjmedia_codec_fmtp *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1param_1name_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjmedia_codec_fmtp_param *arg1 = (pjmedia_codec_fmtp_param *) 0 ;
  ...
  (void)jarg1_;
  (void)jarg2_;
  arg1 = *(pjmedia_codec_fmtp_param **)&jarg1; 
  arg2 = *(pj_str_t **)&jarg2; 
  if (arg1) (arg1)->name = *arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1param_1name_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_codec_fmtp_param *arg1 = (pjmedia_codec_fmtp_param *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1param_1val_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjmedia_codec_fmtp_param *arg1 = (pjmedia_codec_fmtp_param *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1fmtp_1param_1val_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_codec_fmtp_param *arg1 = (pjmedia_codec_fmtp_param *) 0 ;
  pj_str_t *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_codec_fmtp_param **)&jarg1; 
  result = (pj_str_t *)& ((arg1)->val);
  *(pj_str_t **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjmedia_1codec_1fmtp_1param(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjmedia_codec_fmtp_param *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_codec_fmtp_param *)new pjmedia_codec_fmtp_param();
  *(pjmedia_codec_fmtp_param **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjmedia_1codec_1fmtp_1param(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjmedia_codec_fmtp_param *arg1 = (pjmedia_codec_fmtp_param *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1enc_1fmtp_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp *arg2 = (pjmedia_codec_fmtp *) 0 ;
  ...
  (void)jarg2_;
  arg1 = *(pjmedia_codec_param_setting **)&jarg1; 
  arg2 = *(pjmedia_codec_fmtp **)&jarg2; 
  if (arg1) (arg1)->enc_fmtp = *arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1enc_1fmtp_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_codec_param_setting **)&jarg1; 
  result = (pjmedia_codec_fmtp *)& ((arg1)->enc_fmtp);
  *(pjmedia_codec_fmtp **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1dec_1fmtp_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp *arg2 = (pjmedia_codec_fmtp *) 0 ;
  ...
  arg1 = *(pjmedia_codec_param_setting **)&jarg1; 
  arg2 = *(pjmedia_codec_fmtp **)&jarg2; 
  if (arg1) (arg1)->dec_fmtp = *arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1dec_1fmtp_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_codec_param_setting **)&jarg1; 
  result = (pjmedia_codec_fmtp *)& ((arg1)->dec_fmtp);
  *(pjmedia_codec_fmtp **)&jresult = result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1info_1fmt_1id_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_codec_param_info *arg1 = (pjmedia_codec_param_info *) 0 ;
  ...
  if (arg1) (arg1)->fmt_id = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1info_1fmt_1id_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_codec_param_info *arg1 = (pjmedia_codec_param_info *) 0 ;
  pjmedia_format_id result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_codec_param_info **)&jarg1; 
  result = (pjmedia_format_id) ((arg1)->fmt_id);
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJSIP_1SC_1_1force_132bit_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjsip_status_code result;
  
  (void)jenv;
  (void)jcls;
  result = (pjsip_status_code)PJSIP_SC__force_32bit;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1clone_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
  void *(*arg2)(pj_pool_t *,void const *) = (void *(*)(pj_pool_t *,void const *)) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjsip_hdr_vptr **)&jarg1; 
  arg2 = *(void *(**)(pj_pool_t *,void const *))&jarg2; 
  if (arg1) (arg1)->clone = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1clone_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
  void *(*result)(pj_pool_t *,void const *) = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjsip_hdr_vptr **)&jarg1; 
  result = (void *(*)(pj_pool_t *,void const *)) ((arg1)->clone);
  *(void *(**)(pj_pool_t *,void const *))&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1shallow_1clone_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
  void *(*arg2)(pj_pool_t *,void const *) = (void *(*)(pj_pool_t *,void const *)) 0 ;
  ...
  arg1 = *(pjsip_hdr_vptr **)&jarg1; 
  arg2 = *(void *(**)(pj_pool_t *,void const *))&jarg2; 
  if (arg1) (arg1)->shallow_clone = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1shallow_1clone_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
  void *(*result)(pj_pool_t *,void const *) = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjsip_hdr_vptr **)&jarg1; 
  result = (void *(*)(pj_pool_t *,void const *)) ((arg1)->shallow_clone);
  *(void *(**)(pj_pool_t *,void const *))&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1print_1on_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
  int (*arg2)(void *,char *,pj_size_t) = (int (*)(void *,char *,pj_size_t)) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjsip_hdr_vptr **)&jarg1; 
  arg2 = *(int (**)(void *,char *,pj_size_t))&jarg2; 
  if (arg1) (arg1)->print_on = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1print_1on_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
  int (*result)(void *,char *,pj_size_t) = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjsip_hdr_vptr **)&jarg1; 
  result = (int (*)(void *,char *,pj_size_t)) ((arg1)->print_on);
  *(int (**)(void *,char *,pj_size_t))&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjsip_1hdr_1vptr(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjsip_hdr_vptr *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjsip_hdr_vptr *)new pjsip_hdr_vptr();
  *(pjsip_hdr_vptr **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjsip_1hdr_1vptr(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjsip_hdr_vptr *arg1 = (pjsip_hdr_vptr *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1type_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pjsip_hdr_e arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjsip_hdr **)&jarg1; 
  arg2 = (pjsip_hdr_e)jarg2; 
  if (arg1) (arg1)->type = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1type_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pjsip_hdr_e result;
  ...
  (void)jarg1_;
  arg1 = *(pjsip_hdr **)&jarg1; 
  result = (pjsip_hdr_e) ((arg1)->type);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1name_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1name_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1sname_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
  ...
  arg1 = *(pjsip_hdr **)&jarg1; 
  arg2 = *(pj_str_t **)&jarg2; 
  if (arg1) (arg1)->sname = *arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1sname_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pj_str_t *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjsip_hdr **)&jarg1; 
  result = (pj_str_t *)& ((arg1)->sname);
  *(pj_str_t **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pjsip_hdr_vptr *arg2 = (pjsip_hdr_vptr *) 0 ;
  ...
  (void)jarg2_;
  arg1 = *(pjsip_hdr **)&jarg1; 
  arg2 = *(pjsip_hdr_vptr **)&jarg2; 
  if (arg1) (arg1)->vptr = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1hdr_1vptr_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
  pjsip_hdr_vptr *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjsip_hdr **)&jarg1; 
  result = (pjsip_hdr_vptr *) ((arg1)->vptr);
  *(pjsip_hdr_vptr **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjsip_1hdr(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjsip_hdr *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjsip_hdr *)new pjsip_hdr();
  *(pjsip_hdr **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjsip_1hdr(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjsip_hdr *arg1 = (pjsip_hdr *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1type_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pjsip_hdr_e arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjsip_generic_string_hdr **)&jarg1; 
  arg2 = (pjsip_hdr_e)jarg2; 
  if (arg1) (arg1)->type = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1type_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pjsip_hdr_e result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1name_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1name_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1sname_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1sname_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1vptr_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pjsip_hdr_vptr *arg2 = (pjsip_hdr_vptr *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1vptr_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pjsip_hdr_vptr *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1hvalue_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1hvalue_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjsip_generic_string_hdr **)&jarg1; 
  result = (pj_str_t *)& ((arg1)->hvalue);
  *(pj_str_t **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjsip_1generic_1string_1hdr(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjsip_generic_string_hdr *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjsip_generic_string_hdr *)new pjsip_generic_string_hdr();
  *(pjsip_generic_string_hdr **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjsip_1generic_1string_1hdr(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1create(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jlong jarg3, jobject jarg3_) {
  jlong jresult = 0 ;
  pj_pool_t *arg1 = (pj_pool_t *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  ...
  arg2 = *(pj_str_t **)&jarg2; 
  arg3 = *(pj_str_t **)&jarg3; 
  result = (pjsip_generic_string_hdr *)pjsip_generic_string_hdr_create(arg1,(pj_str_t const *)arg2,(pj_str_t const *)arg3);
  *(pjsip_generic_string_hdr **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1STUN_1PASSWD_1PLAIN_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pj_stun_passwd_type result;
  
  (void)jenv;
  (void)jcls;
  result = (pj_stun_passwd_type)PJ_STUN_PASSWD_PLAIN;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1STUN_1PASSWD_1HASHED_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pj_stun_passwd_type result;
  
  (void)jenv;
  (void)jcls;
  result = (pj_stun_passwd_type)PJ_STUN_PASSWD_HASHED;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1type_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pj_stun_auth_cred *arg1 = (pj_stun_auth_cred *) 0 ;
  pj_stun_auth_cred_type arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred **)&jarg1; 
  arg2 = (pj_stun_auth_cred_type)jarg2; 
  if (arg1) (arg1)->type = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1type_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pj_stun_auth_cred *arg1 = (pj_stun_auth_cred *) 0 ;
  pj_stun_auth_cred_type result;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred **)&jarg1; 
  result = (pj_stun_auth_cred_type) ((arg1)->type);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred *arg1 = (pj_stun_auth_cred *) 0 ;
  pj_stun_auth_cred_data *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred **)&jarg1; 
  result = (pj_stun_auth_cred_data *)& ((arg1)->data);
  *(pj_stun_auth_cred_data **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pj_1stun_1auth_1cred(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pj_stun_auth_cred *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pj_stun_auth_cred *)new pj_stun_auth_cred();
  *(pj_stun_auth_cred **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pj_1stun_1auth_1cred(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pj_stun_auth_cred *arg1 = (pj_stun_auth_cred *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data *arg1 = (pj_stun_auth_cred_data *) 0 ;
  pj_stun_auth_cred_data_dyn_cred *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data **)&jarg1; 
  result = (pj_stun_auth_cred_data_dyn_cred *)& ((arg1)->dyn_cred);
  *(pj_stun_auth_cred_data_dyn_cred **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data *arg1 = (pj_stun_auth_cred_data *) 0 ;
  pj_stun_auth_cred_data_static_cred *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data **)&jarg1; 
  result = (pj_stun_auth_cred_data_static_cred *)& ((arg1)->static_cred);
  *(pj_stun_auth_cred_data_static_cred **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pj_1stun_1auth_1cred_1data(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pj_stun_auth_cred_data *)new pj_stun_auth_cred_data();
  *(pj_stun_auth_cred_data **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pj_1stun_1auth_1cred_1data(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pj_stun_auth_cred_data *arg1 = (pj_stun_auth_cred_data *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1user_1data_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, void * jarg2) {
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  void *arg2 = (void *) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
...
SWIGEXPORT void * JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1user_1data_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  void * jresult = 0 ;
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  void *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get_1auth_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_status_t (*arg2)(void *,pj_pool_t *,pj_str_t *,pj_str_t *) = (pj_status_t (*)(void *,pj_pool_t *,pj_str_t *,pj_str_t *)) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  arg2 = *(pj_status_t (**)(void *,pj_pool_t *,pj_str_t *,pj_str_t *))&jarg2; 
  if (arg1) (arg1)->get_auth = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get_1auth_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_status_t (*result)(void *,pj_pool_t *,pj_str_t *,pj_str_t *) = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  result = (pj_status_t (*)(void *,pj_pool_t *,pj_str_t *,pj_str_t *)) ((arg1)->get_auth);
  *(pj_status_t (**)(void *,pj_pool_t *,pj_str_t *,pj_str_t *))&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get_1cred_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_status_t (*arg2)(pj_stun_msg const *,void *,pj_pool_t *,pj_str_t *,pj_str_t *,pj_str_t *,pj_stun_passwd_type *,pj_str_t *) = (pj_status_t (*)(pj_stun_msg const *,void *,pj_pool_t *,pj_str_t *,pj_str_t *,pj_str_t *,pj_stun_passwd_type *,pj_str_t *)) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  arg2 = *(pj_status_t (**)(pj_stun_msg const *,void *,pj_pool_t *,pj_str_t *,pj_str_t *,pj_str_t *,pj_stun_passwd_type *,pj_str_t *))&jarg2; 
  if (arg1) (arg1)->get_cred = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get_1cred_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_status_t (*result)(pj_stun_msg const *,void *,pj_pool_t *,pj_str_t *,pj_str_t *,pj_str_t *,pj_stun_passwd_type *,pj_str_t *) = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  result = (pj_status_t (*)(pj_stun_msg const *,void *,pj_pool_t *,pj_str_t *,pj_str_t *,pj_str_t *,pj_stun_passwd_type *,pj_str_t *)) ((arg1)->get_cred);
  *(pj_status_t (**)(pj_stun_msg const *,void *,pj_pool_t *,pj_str_t *,pj_str_t *,pj_str_t *,pj_stun_passwd_type *,pj_str_t *))&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get_1password_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_status_t (*arg2)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_pool_t *,pj_stun_passwd_type *,pj_str_t *) = (pj_status_t (*)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_pool_t *,pj_stun_passwd_type *,pj_str_t *)) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  arg2 = *(pj_status_t (**)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_pool_t *,pj_stun_passwd_type *,pj_str_t *))&jarg2; 
  if (arg1) (arg1)->get_password = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1get_1password_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_status_t (*result)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_pool_t *,pj_stun_passwd_type *,pj_str_t *) = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  result = (pj_status_t (*)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_pool_t *,pj_stun_passwd_type *,pj_str_t *)) ((arg1)->get_password);
  *(pj_status_t (**)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_pool_t *,pj_stun_passwd_type *,pj_str_t *))&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1verify_1nonce_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_bool_t (*arg2)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_str_t const *) = (pj_bool_t (*)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_str_t const *)) 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  arg2 = *(pj_bool_t (**)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_str_t const *))&jarg2; 
  if (arg1) (arg1)->verify_nonce = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1dyn_1cred_1verify_1nonce_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
  pj_bool_t (*result)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_str_t const *) = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_dyn_cred **)&jarg1; 
  result = (pj_bool_t (*)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_str_t const *)) ((arg1)->verify_nonce);
  *(pj_bool_t (**)(pj_stun_msg const *,void *,pj_str_t const *,pj_str_t const *,pj_str_t const *))&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pj_1stun_1auth_1cred_1data_1dyn_1cred(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_dyn_cred *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pj_stun_auth_cred_data_dyn_cred *)new pj_stun_auth_cred_data_dyn_cred();
  *(pj_stun_auth_cred_data_dyn_cred **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pj_1stun_1auth_1cred_1data_1dyn_1cred(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pj_stun_auth_cred_data_dyn_cred *arg1 = (pj_stun_auth_cred_data_dyn_cred *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1realm_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
  ...
  (void)jarg1_;
  (void)jarg2_;
  arg1 = *(pj_stun_auth_cred_data_static_cred **)&jarg1; 
  arg2 = *(pj_str_t **)&jarg2; 
  if (arg1) (arg1)->realm = *arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1realm_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1username_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1username_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1data_1type_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_stun_passwd_type arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_static_cred **)&jarg1; 
  arg2 = (pj_stun_passwd_type)jarg2; 
  if (arg1) (arg1)->data_type = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1data_1type_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_stun_passwd_type result;
  ...
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_static_cred **)&jarg1; 
  result = (pj_stun_passwd_type) ((arg1)->data_type);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1data_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1data_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1nonce_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1stun_1auth_1cred_1data_1static_1cred_1nonce_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
  pj_str_t *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pj_stun_auth_cred_data_static_cred **)&jarg1; 
  result = (pj_str_t *)& ((arg1)->nonce);
  *(pj_str_t **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pj_1stun_1auth_1cred_1data_1static_1cred(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pj_stun_auth_cred_data_static_cred *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pj_stun_auth_cred_data_static_cred *)new pj_stun_auth_cred_data_static_cred();
  *(pj_stun_auth_cred_data_static_cred **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pj_1stun_1auth_1cred_1data_1static_1cred(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pj_stun_auth_cred_data_static_cred *arg1 = (pj_stun_auth_cred_data_static_cred *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1msg_1add_1hdr(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsua_msg_data *arg1 = (pjsua_msg_data *) 0 ;
  pjsip_generic_string_hdr *arg2 = (pjsip_generic_string_hdr *) 0 ;
  ...
  arg2 = *(pjsip_generic_string_hdr **)&jarg2; 
  pjsip_msg_add_hdr(arg1,arg2);
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_snd_1get_1dev_1count(JNIEnv *jenv, jclass jcls) {
  ...
  (void)jenv;
  (void)jcls;
  result = (int)pjmedia_snd_get_dev_count();
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1thread_1register(JNIEnv *jenv, jclass jcls, jstring jarg1, jintArray jarg2, jobject jarg3) {
  jint jresult = 0 ;
  char *arg1 = (char *) 0 ;
  long *arg2 ;
  pj_thread_t **arg3 = (pj_thread_t **) 0 ;
  jint *jarr2 ;
  pj_thread_t *ppThread3 = 0 ;
  pj_status_t result;
  ...
  if (!SWIG_JavaArrayInLong(jenv, &jarr2, &arg2, jarg2)) return 0; 
  
  arg3 = &ppThread3;
  
  result = (pj_status_t)pj_thread_register((char const *)arg1,arg2,arg3);
  jresult = (jint)result; 
  SWIG_JavaArrayArgoutLong(jenv, jarr2, arg2, jarg2); 
  if (arg1) jenv->ReleaseStringUTFChars(jarg1, (const char *)arg1);
  delete [] arg2; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1thread_1is_1registered(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pj_bool_t result;
  
  (void)jenv;
  (void)jcls;
  result = (pj_bool_t)pj_thread_is_registered();
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsip_1generic_1string_1hdr_1init2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jlong jarg3, jobject jarg3_) {
  pjsip_generic_string_hdr *arg1 = (pjsip_generic_string_hdr *) 0 ;
  pj_str_t *arg2 = (pj_str_t *) 0 ;
  pj_str_t *arg3 = (pj_str_t *) 0 ;
  ...
  arg2 = *(pj_str_t **)&jarg2; 
  arg3 = *(pj_str_t **)&jarg3; 
  pjsip_generic_string_hdr_init2(arg1,arg2,arg3);
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1config_1stun_1srv_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsua_config *arg1 = (pjsua_config *) 0 ;
  pj_str_t *arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1config_1stun_1srv_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjsua_config *arg1 = (pjsua_config *) 0 ;
  pj_str_t *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1msg_1data_1hdr_1list_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsua_msg_data *arg1 = (pjsua_msg_data *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1msg_1data_1hdr_1list_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  (void)jarg1_;
  arg1 = *(pjsua_msg_data **)&jarg1; 
  result = (pjsip_hdr *)& ((arg1)->hdr_list);
  *(pjsip_hdr **)&jresult = result; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_resolve_1stun_1servers(JNIEnv *jenv, jclass jcls, jlong jarg1, jlong jarg2, jobject jarg2_, jint jarg3, void * jarg4, jlong jarg5) {
  jint jresult = 0 ;
  unsigned int arg1 ;
  pj_str_t *arg2 ;
  pj_bool_t arg3 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1acc_1config_1reg_1hdr_1list_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsua_acc_config *arg1 = (pjsua_acc_config *) 0 ;
  pjsip_hdr *arg2 = (pjsip_hdr *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1acc_1config_1reg_1hdr_1list_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  (void)jarg1_;
  arg1 = *(pjsua_acc_config **)&jarg1; 
  result = (pjsip_hdr *)& ((arg1)->reg_hdr_list);
  *(pjsip_hdr **)&jresult = result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1media_1config_1turn_1auth_1cred_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  pjsua_media_config *arg1 = (pjsua_media_config *) 0 ;
  pj_stun_auth_cred *arg2 = (pj_stun_auth_cred *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjsua_1media_1config_1turn_1auth_1cred_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  (void)jarg1_;
  arg1 = *(pjsua_media_config **)&jarg1; 
  result = (pj_stun_auth_cred *)& ((arg1)->turn_auth_cred);
  *(pj_stun_auth_cred **)&jresult = result; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_player_1get_1port(JNIEnv *jenv, jclass jcls, jint jarg1, jobject jarg2) {
  jint jresult = 0 ;
  pjsua_player_id arg1 ;
  pjmedia_port **arg2 = (pjmedia_port **) 0 ;
  pjmedia_port *ppMediaPort2 = 0 ;
  pj_status_t result;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_recorder_1get_1port(JNIEnv *jenv, jclass jcls, jint jarg1, jobject jarg2) {
  jint jresult = 0 ;
  pjsua_recorder_id arg1 ;
  pjmedia_port **arg2 = (pjmedia_port **) 0 ;
  pjmedia_port *ppMediaPort2 = 0 ;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_enum_1aud_1devs(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlongArray jarg2) {
  jint jresult = 0 ;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_snd_1set_1setting(JNIEnv *jenv, jclass jcls, jint jarg1, void * jarg2, jint jarg3) {
  jint jresult = 0 ;
  ...
  (void)jenv;
  (void)jcls;
  arg1 = (pjmedia_aud_dev_cap)jarg1; 
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_snd_1get_1setting(JNIEnv *jenv, jclass jcls, jint jarg1, void * jarg2) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap arg1 ;
  void *arg2 = (void *) 0 ;
  pj_status_t result;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1ERR_1MSG_1SIZE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1PERROR_1TITLE_1BUF_1SIZE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1get_1os_1error(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pj_status_t result;
  
  (void)jenv;
  (void)jcls;
  result = (pj_status_t)pj_get_os_error();
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1set_1os_1error(JNIEnv *jenv, jclass jcls, jint jarg1) {
  pj_status_t arg1 ;
  
  (void)jenv;
  (void)jcls;
  arg1 = (pj_status_t)jarg1; 
  pj_set_os_error(arg1);
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1get_1netos_1error(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pj_status_t result;
  
  (void)jenv;
  (void)jcls;
  result = (pj_status_t)pj_get_netos_error();
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1set_1netos_1error(JNIEnv *jenv, jclass jcls, jint jarg1) {
  pj_status_t arg1 ;
  
  (void)jenv;
  (void)jcls;
  arg1 = (pj_status_t)jarg1; 
  pj_set_netos_error(arg1);
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1strerror(JNIEnv *jenv, jclass jcls, jint jarg1, jstring jarg2, jlong jarg3) {
  jlong jresult = 0 ;
  pj_status_t arg1 ;
  char *arg2 = (char *) 0 ;
  pj_size_t arg3 ;
  ...
  arg3 = (pj_size_t)jarg3; 
  result = pj_strerror(arg1,arg2,arg3);
  *(pj_str_t **)&jresult = new pj_str_t((const pj_str_t &)result); 
  if (arg2) jenv->ReleaseStringUTFChars(jarg2, (const char *)arg2);
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1perror(JNIEnv *jenv, jclass jcls, jint jarg1, jstring jarg2, jint jarg3, jstring jarg4) {
  int arg1 ;
  char *arg2 = (char *) 0 ;
  pj_status_t arg3 ;
  char *arg4 = (char *) 0 ;
  ...
  pj_perror(arg1,(char const *)arg2,arg3,(char const *)arg4,arg5);
  if (arg2) jenv->ReleaseStringUTFChars(jarg2, (const char *)arg2);
  if (arg4) jenv->ReleaseStringUTFChars(jarg4, (const char *)arg4);
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1register_1strerror(JNIEnv *jenv, jclass jcls, jint jarg1, jint jarg2, jlong jarg3) {
  jint jresult = 0 ;
  pj_status_t arg1 ;
  pj_status_t arg2 ;
  pj_error_callback arg3 = (pj_error_callback) 0 ;
  pj_status_t result;
  ...
  arg1 = (pj_status_t)jarg1; 
  arg2 = (pj_status_t)jarg2; 
  arg3 = *(pj_error_callback *)&jarg3; 
  result = (pj_status_t)pj_register_strerror(arg1,arg2,arg3);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1ERRNO_1START_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1ERRNO_1SPACE_1SIZE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1ERRNO_1START_1STATUS_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int) (20000+50000);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1ERRNO_1START_1SYS_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int) ((20000+50000) +50000);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJ_1ERRNO_1START_1USER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int) (((20000+50000) +50000) +50000);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pj_1errno_1clear_1handlers(JNIEnv *jenv, jclass jcls) {
  (void)jenv;
  (void)jcls;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1create(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jint jarg3, jlong jarg4, jlong jarg5, jlong jarg6, jlong jarg7, jlong jarg8, jobject jarg9) {
  jint jresult = 0 ;
  pj_pool_t *arg1 = (pj_pool_t *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  unsigned int arg7 ;
  unsigned int arg8 ;
  pjmedia_snd_port **arg9 = (pjmedia_snd_port **) 0 ;
  pjmedia_snd_port *ppMediaPort9 = 0 ;
  pj_status_t result;
  ...
  result = (pj_status_t)pjmedia_snd_port_create(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9);
  jresult = (jint)result; 
  {
    // Give Java proxy the C pointer (of newly created object)
    ...
    jfieldID fid = jenv->GetFieldID(clazz, "swigCPtr", "J");
    jlong cPtr = 0;
    *(pjmedia_snd_port **)&cPtr = *arg9;
    jenv->SetLongField(jarg9, fid, cPtr);
  }
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1create_1rec(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jlong jarg5, jlong jarg6, jlong jarg7, jobject jarg8) {
  jint jresult = 0 ;
  pj_pool_t *arg1 = (pj_pool_t *) 0 ;
  int arg2 ;
  unsigned int arg3 ;
  ...
  unsigned int arg6 ;
  unsigned int arg7 ;
  pjmedia_snd_port **arg8 = (pjmedia_snd_port **) 0 ;
  pjmedia_snd_port *ppMediaPort8 = 0 ;
  pj_status_t result;
  ...
  result = (pj_status_t)pjmedia_snd_port_create_rec(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
  jresult = (jint)result; 
  {
    // Give Java proxy the C pointer (of newly created object)
    jclass clazz = jenv->FindClass("org/pjsip/pjsua/pjmedia_snd_port");
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1create_1player(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jlong jarg4, jlong jarg5, jlong jarg6, jlong jarg7, jobject jarg8) {
  jint jresult = 0 ;
  pj_pool_t *arg1 = (pj_pool_t *) 0 ;
  int arg2 ;
  unsigned int arg3 ;
  ...
  result = (pj_status_t)pjmedia_snd_port_create_player(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
  jresult = (jint)result; 
  {
    // Give Java proxy the C pointer (of newly created object)
    jclass clazz = jenv->FindClass("org/pjsip/pjsua/pjmedia_snd_port");
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1create2(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jobject jarg3) {
  jint jresult = 0 ;
  pj_pool_t *arg1 = (pj_pool_t *) 0 ;
  pjmedia_aud_param *arg2 = (pjmedia_aud_param *) 0 ;
  pjmedia_snd_port **arg3 = (pjmedia_snd_port **) 0 ;
  pjmedia_snd_port *ppMediaPort3 = 0 ;
  pj_status_t result;
  ...
  (void)jarg2_;
  arg1 = *(pj_pool_t **)&jarg1; 
  arg2 = *(pjmedia_aud_param **)&jarg2; 
  
  arg3 = &ppMediaPort3;
  
  result = (pj_status_t)pjmedia_snd_port_create2(arg1,(pjmedia_aud_param const *)arg2,arg3);
  jresult = (jint)result; 
  {
    // Give Java proxy the C pointer (of newly created object)
    jclass clazz = jenv->FindClass("org/pjsip/pjsua/pjmedia_snd_port");
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1destroy(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  pj_status_t result;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  result = (pj_status_t)pjmedia_snd_port_destroy(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1get_1snd_1stream(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  pjmedia_aud_stream *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  result = (pjmedia_aud_stream *)pjmedia_snd_port_get_snd_stream(arg1);
  *(pjmedia_aud_stream **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1set_1ec(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jlong jarg3, jlong jarg4) {
  jint jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  ...
  arg3 = (unsigned int)jarg3; 
  arg4 = (unsigned int)jarg4; 
  result = (pj_status_t)pjmedia_snd_port_set_ec(arg1,arg2,arg3,arg4);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1get_1ec_1tail(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  jint jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  unsigned int *arg2 = (unsigned int *) 0 ;
  pj_status_t result;
  ...
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  arg2 = *(unsigned int **)&jarg2; 
  result = (pj_status_t)pjmedia_snd_port_get_ec_tail(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1connect(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  jint jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  pjmedia_port *arg2 = (pjmedia_port *) 0 ;
  pj_status_t result;
  ...
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  arg2 = *(pjmedia_port **)&jarg2; 
  result = (pj_status_t)pjmedia_snd_port_connect(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1get_1port(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  pjmedia_port *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  result = (pjmedia_port *)pjmedia_snd_port_get_port(arg1);
  *(pjmedia_port **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1disconnect(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  pj_status_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  result = (pj_status_t)pjmedia_snd_port_disconnect(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEFAULT_1CAPTURE_1DEV_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int)PJMEDIA_AUD_DEFAULT_CAPTURE_DEV;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEFAULT_1PLAYBACK_1DEV_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int)PJMEDIA_AUD_DEFAULT_PLAYBACK_DEV;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1INVALID_1DEV_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int)PJMEDIA_AUD_INVALID_DEV;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1EXT_1FORMAT_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_EXT_FORMAT;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1INPUT_1LATENCY_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_INPUT_LATENCY;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1OUTPUT_1LATENCY_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_OUTPUT_LATENCY;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1INPUT_1VOLUME_1SETTING_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_INPUT_VOLUME_SETTING;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1OUTPUT_1VOLUME_1SETTING_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_OUTPUT_VOLUME_SETTING;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1INPUT_1SIGNAL_1METER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_INPUT_SIGNAL_METER;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1OUTPUT_1SIGNAL_1METER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_OUTPUT_SIGNAL_METER;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1INPUT_1ROUTE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_INPUT_ROUTE;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1OUTPUT_1ROUTE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_OUTPUT_ROUTE;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1EC_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_EC;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1EC_1TAIL_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_EC_TAIL;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1VAD_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_VAD;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1CNG_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_CNG;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1PLC_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_PLC;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1CAP_1MAX_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_cap result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_cap)PJMEDIA_AUD_DEV_CAP_MAX;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1ROUTE_1DEFAULT_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_route result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_route)PJMEDIA_AUD_DEV_ROUTE_DEFAULT;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1ROUTE_1LOUDSPEAKER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_route result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_route)PJMEDIA_AUD_DEV_ROUTE_LOUDSPEAKER;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1ROUTE_1EARPIECE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_route result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_route)PJMEDIA_AUD_DEV_ROUTE_EARPIECE;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_PJMEDIA_1AUD_1DEV_1ROUTE_1BLUETOOTH_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pjmedia_aud_dev_route result;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_route)PJMEDIA_AUD_DEV_ROUTE_BLUETOOTH;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1name_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  char *arg2 ;
...
SWIGEXPORT jstring JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1name_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jstring jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  char *result = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1input_1count_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1input_1count_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1output_1count_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1output_1count_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1default_1samples_1per_1sec_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1default_1samples_1per_1sec_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1driver_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  char *arg2 ;
  ...
  {
    if (arg2) strncpy((char *)arg1->driver, (const char *)arg2, 32);
    else arg1->driver[0] = 0;
  }
...
SWIGEXPORT jstring JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1driver_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jstring jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  char *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_dev_info **)&jarg1; 
  result = (char *)(char *) ((arg1)->driver);
  if(result) jresult = jenv->NewStringUTF((const char *)result);
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1caps_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1caps_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1routes_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1routes_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1ext_1fmt_1cnt_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int arg2 ;
  ...
  arg1 = *(pjmedia_aud_dev_info **)&jarg1; 
  arg2 = (unsigned int)jarg2; 
  if (arg1) (arg1)->ext_fmt_cnt = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1ext_1fmt_1cnt_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  unsigned int result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_dev_info **)&jarg1; 
  result = (unsigned int) ((arg1)->ext_fmt_cnt);
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1ext_1fmt_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  pjmedia_format *arg2 ;
  ...
  {
    size_t ii;
    pjmedia_format *b = (pjmedia_format *) arg1->ext_fmt;
    for (ii = 0; ii < (size_t)8; ii++) b[ii] = *((pjmedia_format *) arg2 + ii);
  }
  
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1info_1ext_1fmt_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
  pjmedia_format *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_aud_dev_info **)&jarg1; 
  result = (pjmedia_format *)(pjmedia_format *) ((arg1)->ext_fmt);
  *(pjmedia_format **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjmedia_1aud_1dev_1info(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjmedia_aud_dev_info *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_dev_info *)new pjmedia_aud_dev_info();
  *(pjmedia_aud_dev_info **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjmedia_1aud_1dev_1info(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjmedia_aud_dev_info *arg1 = (pjmedia_aud_dev_info *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1dir_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_dir arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pjmedia_dir)jarg2; 
  if (arg1) (arg1)->dir = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1dir_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_dir result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1rec_1id_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pjmedia_aud_dev_index)jarg2; 
  if (arg1) (arg1)->rec_id = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1rec_1id_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pjmedia_aud_dev_index) ((arg1)->rec_id);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1play_1id_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_dev_index arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pjmedia_aud_dev_index)jarg2; 
  if (arg1) (arg1)->play_id = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1play_1id_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_dev_index result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pjmedia_aud_dev_index) ((arg1)->play_id);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1clock_1rate_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1clock_1rate_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1channel_1count_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1channel_1count_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1samples_1per_1frame_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1samples_1per_1frame_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1bits_1per_1sample_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1bits_1per_1sample_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1flags_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1flags_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1ext_1fmt_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_format arg2 ;
  ...
  arg2 = *argp2; 
  if (arg1) (arg1)->ext_fmt = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1ext_1fmt_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1input_1latency_1ms_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (unsigned int)jarg2; 
  if (arg1) (arg1)->input_latency_ms = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1input_1latency_1ms_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (unsigned int) ((arg1)->input_latency_ms);
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1output_1latency_1ms_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (unsigned int)jarg2; 
  if (arg1) (arg1)->output_latency_ms = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1output_1latency_1ms_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (unsigned int) ((arg1)->output_latency_ms);
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1input_1vol_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (unsigned int)jarg2; 
  if (arg1) (arg1)->input_vol = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1input_1vol_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (unsigned int) ((arg1)->input_vol);
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1output_1vol_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (unsigned int)jarg2; 
  if (arg1) (arg1)->output_vol = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1output_1vol_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (unsigned int) ((arg1)->output_vol);
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1input_1route_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  ...
  if (arg1) (arg1)->input_route = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1input_1route_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_dev_route result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pjmedia_aud_dev_route) ((arg1)->input_route);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1output_1route_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_dev_route arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pjmedia_aud_dev_route)jarg2; 
  if (arg1) (arg1)->output_route = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1output_1route_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_dev_route result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pjmedia_aud_dev_route) ((arg1)->output_route);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1ec_1enabled_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pj_bool_t arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pj_bool_t)jarg2; 
  if (arg1) (arg1)->ec_enabled = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1ec_1enabled_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pj_bool_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pj_bool_t) ((arg1)->ec_enabled);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1ec_1tail_1ms_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (unsigned int)jarg2; 
  if (arg1) (arg1)->ec_tail_ms = arg2;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1ec_1tail_1ms_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  unsigned int result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (unsigned int) ((arg1)->ec_tail_ms);
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1plc_1enabled_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pj_bool_t arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pj_bool_t)jarg2; 
  if (arg1) (arg1)->plc_enabled = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1plc_1enabled_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pj_bool_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pj_bool_t) ((arg1)->plc_enabled);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1cng_1enabled_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pj_bool_t arg2 ;
  ...
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = (pj_bool_t)jarg2; 
  if (arg1) (arg1)->cng_enabled = arg2;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1cng_1enabled_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pj_bool_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  result = (pj_bool_t) ((arg1)->cng_enabled);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjmedia_1aud_1param(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjmedia_aud_param *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_aud_param *)new pjmedia_aud_param();
  *(pjmedia_aud_param **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjmedia_1aud_1param(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
...
SWIGEXPORT jstring JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1cap_1name(JNIEnv *jenv, jclass jcls, jint jarg1, jlong jarg2) {
  jstring jresult = 0 ;
  pjmedia_aud_dev_cap arg1 ;
  char **arg2 = (char **) 0 ;
  char *result = 0 ;
  ...
  arg1 = (pjmedia_aud_dev_cap)jarg1; 
  arg2 = *(char ***)&jarg2; 
  result = (char *)pjmedia_aud_dev_cap_name(arg1,(char const **)arg2);
  if(result) jresult = jenv->NewStringUTF((const char *)result);
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1set_1cap(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, void * jarg3) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  ...
  result = (pj_status_t)pjmedia_aud_param_set_cap(arg1,arg2,(void const *)arg3);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1param_1get_1cap(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, void * jarg3) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_dev_cap arg2 ;
  void *arg3 = (void *) 0 ;
  ...
  result = (pj_status_t)pjmedia_aud_param_get_cap((pjmedia_aud_param const *)arg1,arg2,arg3);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1subsys_1init(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  ...
  result = (pj_status_t)pjmedia_aud_subsys_init(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1subsys_1get_1pool_1factory(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pj_pool_factory *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pj_pool_factory *)pjmedia_aud_subsys_get_pool_factory();
  *(pj_pool_factory **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1subsys_1shutdown(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  pj_status_t result;
  
  (void)jenv;
  (void)jcls;
  result = (pj_status_t)pjmedia_aud_subsys_shutdown();
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1register_1factory(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  pjmedia_aud_dev_factory_create_func_ptr arg1 = (pjmedia_aud_dev_factory_create_func_ptr) 0 ;
  pj_status_t result;
  
  (void)jenv;
  (void)jcls;
  arg1 = *(pjmedia_aud_dev_factory_create_func_ptr *)&jarg1; 
  result = (pj_status_t)pjmedia_aud_register_factory(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1unregister_1factory(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  pjmedia_aud_dev_factory_create_func_ptr arg1 = (pjmedia_aud_dev_factory_create_func_ptr) 0 ;
  pj_status_t result;
  ...
  (void)jcls;
  arg1 = *(pjmedia_aud_dev_factory_create_func_ptr *)&jarg1; 
  result = (pj_status_t)pjmedia_aud_unregister_factory(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1count(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  unsigned int result;
  
  (void)jenv;
  (void)jcls;
  result = (unsigned int)pjmedia_aud_dev_count();
  jresult = (jlong)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1get_1info(JNIEnv *jenv, jclass jcls, jint jarg1, jlong jarg2, jobject jarg2_) {
  jint jresult = 0 ;
  pjmedia_aud_dev_index arg1 ;
  pjmedia_aud_dev_info *arg2 = (pjmedia_aud_dev_info *) 0 ;
  pj_status_t result;
  
  (void)jenv;
  (void)jcls;
  (void)jarg2_;
  arg1 = (pjmedia_aud_dev_index)jarg1; 
  arg2 = *(pjmedia_aud_dev_info **)&jarg2; 
  result = (pj_status_t)pjmedia_aud_dev_get_info(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1lookup(JNIEnv *jenv, jclass jcls, jstring jarg1, jstring jarg2, jlong jarg3) {
  jint jresult = 0 ;
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  pjmedia_aud_dev_index *arg3 = (pjmedia_aud_dev_index *) 0 ;
  pj_status_t result;
  ...
  arg3 = *(pjmedia_aud_dev_index **)&jarg3; 
  result = (pj_status_t)pjmedia_aud_dev_lookup((char const *)arg1,(char const *)arg2,arg3);
  jresult = (jint)result; 
  if (arg1) jenv->ReleaseStringUTFChars(jarg1, (const char *)arg1);
  if (arg2) jenv->ReleaseStringUTFChars(jarg2, (const char *)arg2);
  return jresult;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1dev_1default_1param(JNIEnv *jenv, jclass jcls, jint jarg1, jlong jarg2, jobject jarg2_) {
  jint jresult = 0 ;
  pjmedia_aud_dev_index arg1 ;
  pjmedia_aud_param *arg2 = (pjmedia_aud_param *) 0 ;
  pj_status_t result;
  ...
  arg1 = (pjmedia_aud_dev_index)jarg1; 
  arg2 = *(pjmedia_aud_param **)&jarg2; 
  result = (pj_status_t)pjmedia_aud_dev_default_param(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1create(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jlong jarg3, void * jarg4, jlong jarg5) {
  jint jresult = 0 ;
  pjmedia_aud_param *arg1 = (pjmedia_aud_param *) 0 ;
  pjmedia_aud_rec_cb arg2 = (pjmedia_aud_rec_cb) 0 ;
  pjmedia_aud_play_cb arg3 = (pjmedia_aud_play_cb) 0 ;
  void *arg4 = (void *) 0 ;
  pjmedia_aud_stream **arg5 = (pjmedia_aud_stream **) 0 ;
  pj_status_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_aud_param **)&jarg1; 
  arg2 = *(pjmedia_aud_rec_cb *)&jarg2; 
  arg3 = *(pjmedia_aud_play_cb *)&jarg3; 
  
  arg4 = jarg4;
  
  arg5 = *(pjmedia_aud_stream ***)&jarg5; 
  result = (pj_status_t)pjmedia_aud_stream_create((pjmedia_aud_param const *)arg1,arg2,arg3,arg4,arg5);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1get_1param(JNIEnv *jenv, jclass jcls, jlong jarg1, jlong jarg2, jobject jarg2_) {
  jint jresult = 0 ;
  pjmedia_aud_stream *arg1 = (pjmedia_aud_stream *) 0 ;
  pjmedia_aud_param *arg2 = (pjmedia_aud_param *) 0 ;
  pj_status_t result;
  ...
  (void)jcls;
  (void)jarg2_;
  arg1 = *(pjmedia_aud_stream **)&jarg1; 
  arg2 = *(pjmedia_aud_param **)&jarg2; 
  result = (pj_status_t)pjmedia_aud_stream_get_param(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1get_1cap(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2, void * jarg3) {
  jint jresult = 0 ;
  pjmedia_aud_stream *arg1 = (pjmedia_aud_stream *) 0 ;
  pjmedia_aud_dev_cap arg2 ;
  void *arg3 = (void *) 0 ;
  ...
  result = (pj_status_t)pjmedia_aud_stream_get_cap(arg1,arg2,arg3);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1set_1cap(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2, void * jarg3) {
  jint jresult = 0 ;
  pjmedia_aud_stream *arg1 = (pjmedia_aud_stream *) 0 ;
  pjmedia_aud_dev_cap arg2 ;
  void *arg3 = (void *) 0 ;
  ...
  result = (pj_status_t)pjmedia_aud_stream_set_cap(arg1,arg2,(void const *)arg3);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1start(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  pjmedia_aud_stream *arg1 = (pjmedia_aud_stream *) 0 ;
  pj_status_t result;
  ...
  (void)jcls;
  arg1 = *(pjmedia_aud_stream **)&jarg1; 
  result = (pj_status_t)pjmedia_aud_stream_start(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1stop(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  pjmedia_aud_stream *arg1 = (pjmedia_aud_stream *) 0 ;
  pj_status_t result;
  ...
  (void)jcls;
  arg1 = *(pjmedia_aud_stream **)&jarg1; 
  result = (pj_status_t)pjmedia_aud_stream_stop(arg1);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1aud_1stream_1destroy(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  jint jresult = 0 ;
  pjmedia_aud_stream *arg1 = (pjmedia_aud_stream *) 0 ;
  pj_status_t result;
  ...
  (void)jcls;
  arg1 = *(pjmedia_aud_stream **)&jarg1; 
  result = (pj_status_t)pjmedia_aud_stream_destroy(arg1);
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1count_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1count_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_tone_digit_map *arg1 = (pjmedia_tone_digit_map *) 0 ;
  unsigned int result;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_tone_digit_map *arg1 = (pjmedia_tone_digit_map *) 0 ;
  pjmedia_tone_digit_map_digits *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_tone_digit_map **)&jarg1; 
  result = (pjmedia_tone_digit_map_digits *)(pjmedia_tone_digit_map_digits *) ((arg1)->digits);
  *(pjmedia_tone_digit_map_digits **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjmedia_1tone_1digit_1map(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjmedia_1tone_1digit_1map(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjmedia_tone_digit_map *arg1 = (pjmedia_tone_digit_map *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1digit_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jchar jarg2) {
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
  char arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_tone_digit_map_digits **)&jarg1; 
  arg2 = (char)jarg2; 
  if (arg1) (arg1)->digit = arg2;
}


SWIGEXPORT jchar JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1digit_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jchar jresult = 0 ;
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
  char result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1freq1_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jshort jarg2) {
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
  short arg2 ;
...
SWIGEXPORT jshort JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1freq1_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jshort jresult = 0 ;
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
  short result;
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1freq2_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jshort jarg2) {
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
  short arg2 ;
...
SWIGEXPORT jshort JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tone_1digit_1map_1digits_1freq2_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jshort jresult = 0 ;
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
  short result;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_new_1pjmedia_1tone_1digit_1map_1digits(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  pjmedia_tone_digit_map_digits *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  result = (pjmedia_tone_digit_map_digits *)new pjmedia_tone_digit_map_digits();
  *(pjmedia_tone_digit_map_digits **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_delete_1pjmedia_1tone_1digit_1map_1digits(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  pjmedia_tone_digit_map_digits *arg1 = (pjmedia_tone_digit_map_digits *) 0 ;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tonegen_1create(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jlong jarg3, jlong jarg4, jlong jarg5, jlong jarg6, jobject jarg7) {
  jint jresult = 0 ;
  pj_pool_t *arg1 = (pj_pool_t *) 0 ;
  unsigned int arg2 ;
  unsigned int arg3 ;
  ...
  unsigned int arg5 ;
  unsigned int arg6 ;
  pjmedia_port **arg7 = (pjmedia_port **) 0 ;
  pjmedia_port *ppMediaPort7 = 0 ;
  pj_status_t result;
  ...
  result = (pj_status_t)pjmedia_tonegen_create(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
  jresult = (jint)result; 
  {
    // Give Java proxy the C pointer (of newly created object)
    jclass clazz = jenv->FindClass("org/pjsip/pjsua/pjmedia_port");
    jfieldID fid = jenv->GetFieldID(clazz, "swigCPtr", "J");
    jlong cPtr = 0;
    *(pjmedia_port **)&cPtr = *arg7;
    jenv->SetLongField(jarg7, fid, cPtr);
  }
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tonegen_1is_1busy(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  pjmedia_port *arg1 = (pjmedia_port *) 0 ;
  pj_bool_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_port **)&jarg1; 
  result = (pj_bool_t)pjmedia_tonegen_is_busy(arg1);
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tonegen_1play_1digits(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jlong jarg3, jobject jarg3_, jlong jarg4) {
  jint jresult = 0 ;
  pjmedia_port *arg1 = (pjmedia_port *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tonegen_1get_1digit_1map(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  jint jresult = 0 ;
  pjmedia_port *arg1 = (pjmedia_port *) 0 ;
  pjmedia_tone_digit_map **arg2 = (pjmedia_tone_digit_map **) 0 ;
  pj_status_t result;
  ...
  (void)jarg1_;
  arg1 = *(pjmedia_port **)&jarg1; 
  arg2 = *(pjmedia_tone_digit_map ***)&jarg2; 
  result = (pj_status_t)pjmedia_tonegen_get_digit_map(arg1,(pjmedia_tone_digit_map const **)arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1tonegen_1set_1digit_1map(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  jint jresult = 0 ;
  pjmedia_port *arg1 = (pjmedia_port *) 0 ;
  pjmedia_tone_digit_map *arg2 = (pjmedia_tone_digit_map *) 0 ;
  pj_status_t result;
  ...
  arg1 = *(pjmedia_port **)&jarg1; 
  arg2 = *(pjmedia_tone_digit_map **)&jarg2; 
  result = (pj_status_t)pjmedia_tonegen_set_digit_map(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_swig_1module_1init(JNIEnv *jenv, jclass jcls) {
  ...
  static struct {
    ...
    {
      "SwigDirector_Callback_on_call_state_extended", "(Lorg/pjsip/pjsua/Callback;IJJ)V" 
    },
    {
    ...
    {
      "SwigDirector_Callback_on_reg_state2", "(Lorg/pjsip/pjsua/Callback;IJ)V" 
    },
    {
      "SwigDirector_Callback_on_incoming_subscribe", "(Lorg/pjsip/pjsua/Callback;IJIJJJJJ)V" 
    },
    {
      "SwigDirector_Callback_on_srv_subscribe_state", "(Lorg/pjsip/pjsua/Callback;IJJJJ)V" 
    },
    {
      "SwigDirector_Callback_on_buddy_state", "(Lorg/pjsip/pjsua/Callback;I)V" 
    },
    {
      "SwigDirector_Callback_on_buddy_evsub_state", "(Lorg/pjsip/pjsua/Callback;IJJ)V" 
    },
    {
      "SwigDirector_Callback_on_pager", "(Lorg/pjsip/pjsua/Callback;IJJJJJ)V" 
    },
    {
      "SwigDirector_Callback_on_pager2", "(Lorg/pjsip/pjsua/Callback;IJJJJJJI)V" 
    },
    {
      "SwigDirector_Callback_on_pager_status", "(Lorg/pjsip/pjsua/Callback;IJJIJ)V" 
    },
    {
      "SwigDirector_Callback_on_pager_status2", "(Lorg/pjsip/pjsua/Callback;IJJIJJJI)V" 
    },
    {
      "SwigDirector_Callback_on_typing", "(Lorg/pjsip/pjsua/Callback;IJJJI)V" 
    },
    {
      "SwigDirector_Callback_on_typing2", "(Lorg/pjsip/pjsua/Callback;IJJJIJI)V" 
    },
    {
      "SwigDirector_Callback_on_nat_detect", "(Lorg/pjsip/pjsua/Callback;J)V" 
    },
    {
      "SwigDirector_Callback_on_call_redirected", "(Lorg/pjsip/pjsua/Callback;IJJ)I" 
    },
    {
      "SwigDirector_Callback_on_mwi_info", "(Lorg/pjsip/pjsua/Callback;IJ)V" 
    },
    {
      "SwigDirector_Callback_on_ice_transport_error", "(Lorg/pjsip/pjsua/Callback;IJI)V" 
    }
  };
