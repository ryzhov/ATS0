...
PJ_DECL(pj_status_t) pjmedia_snd_port_create_player(pj_pool_t *pool,
						    ...
						    unsigned options,
						    pjmedia_snd_port **p_port);
%javamethodmodifiers pjmedia_snd_port_create2(pj_pool_t *pool,
...
%javamethodmodifiers pjmedia_aud_dev_cap_name(pjmedia_aud_dev_cap cap,
					      const char **p_desc) "public synchronized";
PJ_DECL(const char*) pjmedia_aud_dev_cap_name(pjmedia_aud_dev_cap cap,
					      const char **p_desc);
%javamethodmodifiers pjmedia_aud_param_set_cap(pjmedia_aud_param *param,
					       pjmedia_aud_dev_cap cap,
					       const void *pval) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_param_set_cap(pjmedia_aud_param *param,
					       pjmedia_aud_dev_cap cap,
					       const void *pval);
%javamethodmodifiers pjmedia_aud_param_get_cap(const pjmedia_aud_param *param,
					       pjmedia_aud_dev_cap cap,
					       void *pval) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_param_get_cap(const pjmedia_aud_param *param,
					       pjmedia_aud_dev_cap cap,
					       void *pval);
%javamethodmodifiers pjmedia_aud_subsys_init(pj_pool_factory *pf) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_subsys_init(pj_pool_factory *pf);
%javamethodmodifiers pjmedia_aud_subsys_get_pool_factory(void) "public synchronized";
PJ_DECL(pj_pool_factory*) pjmedia_aud_subsys_get_pool_factory(void);
%javamethodmodifiers pjmedia_aud_subsys_shutdown(void) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_subsys_shutdown(void);
%javamethodmodifiers pjmedia_aud_register_factory(pjmedia_aud_dev_factory_create_func_ptr adf) "public synchronized";
PJ_DECL(pj_status_t)
pjmedia_aud_register_factory(pjmedia_aud_dev_factory_create_func_ptr adf);
%javamethodmodifiers pjmedia_aud_unregister_factory(pjmedia_aud_dev_factory_create_func_ptr adf) "public synchronized";
PJ_DECL(pj_status_t)
pjmedia_aud_unregister_factory(pjmedia_aud_dev_factory_create_func_ptr adf);
%javamethodmodifiers pjmedia_aud_dev_count(void) "public synchronized";
PJ_DECL(unsigned) pjmedia_aud_dev_count(void);
%javamethodmodifiers pjmedia_aud_dev_get_info(pjmedia_aud_dev_index id,
					      pjmedia_aud_dev_info *info) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_dev_get_info(pjmedia_aud_dev_index id,
					      pjmedia_aud_dev_info *info);
%javamethodmodifiers pjmedia_aud_dev_lookup(const char *drv_name,
					    const char *dev_name,
					    pjmedia_aud_dev_index *id) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_dev_lookup(const char *drv_name,
					    const char *dev_name,
					    pjmedia_aud_dev_index *id);
%javamethodmodifiers pjmedia_aud_dev_default_param(pjmedia_aud_dev_index id,
						   pjmedia_aud_param *param) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_dev_default_param(pjmedia_aud_dev_index id,
						   pjmedia_aud_param *param);
%javamethodmodifiers pjmedia_aud_stream_create(const pjmedia_aud_param *param,
					       pjmedia_aud_rec_cb rec_cb,
					       pjmedia_aud_play_cb play_cb,
					       void *user_data,
					       pjmedia_aud_stream **p_strm) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_stream_create(const pjmedia_aud_param *param,
					       pjmedia_aud_rec_cb rec_cb,
					       pjmedia_aud_play_cb play_cb,
					       void *user_data,
					       pjmedia_aud_stream **p_strm);
%javamethodmodifiers pjmedia_aud_stream_get_param(pjmedia_aud_stream *strm,
						  pjmedia_aud_param *param) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_stream_get_param(pjmedia_aud_stream *strm,
						  pjmedia_aud_param *param);
%javamethodmodifiers pjmedia_aud_stream_get_cap(pjmedia_aud_stream *strm,
						pjmedia_aud_dev_cap cap,
						void *value) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_stream_get_cap(pjmedia_aud_stream *strm,
						pjmedia_aud_dev_cap cap,
						void *value);
%javamethodmodifiers pjmedia_aud_stream_set_cap(pjmedia_aud_stream *strm,
						pjmedia_aud_dev_cap cap,
						const void *value) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_stream_set_cap(pjmedia_aud_stream *strm,
						pjmedia_aud_dev_cap cap,
						const void *value);
%javamethodmodifiers pjmedia_aud_stream_start(pjmedia_aud_stream *strm) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_stream_start(pjmedia_aud_stream *strm);
%javamethodmodifiers pjmedia_aud_stream_stop(pjmedia_aud_stream *strm) "public synchronized";
PJ_DECL(pj_status_t) pjmedia_aud_stream_stop(pjmedia_aud_stream *strm);
%javamethodmodifiers pjmedia_aud_stream_destroy(pjmedia_aud_stream *strm) "public synchronized";
