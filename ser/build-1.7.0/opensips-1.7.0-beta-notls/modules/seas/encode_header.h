/* $Id: encode_header.h 6028 2009-08-26 20:53:50Z bogdan_iancu $
 *
...
int print_encoded_header(FILE *fp,char *msg,int len,unsigned char *payload,int paylen,char type,char *prefix);
